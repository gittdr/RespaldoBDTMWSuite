...
create procedure [dbo].[invoice_template5](@invoice_nbr  	int,@copies		int)
as
...
update #invtemp_tbl 
   set ord_width = (SELECT ord_width 
                      FROM orderheader 
                     WHERE orderheader.ord_hdrnumber = #invtemp_tbl.ord_hdrnumber), 
       ord_length = (SELECT ord_length 
                      FROM orderheader 
                     WHERE orderheader.ord_hdrnumber = #invtemp_tbl.ord_hdrnumber), 
       ord_height = (SELECT ord_height 
                      FROM orderheader 
                     WHERE orderheader.ord_hdrnumber = #invtemp_tbl.ord_hdrnumber)
...
GO
GRANT EXECUTE ON  [dbo].[invoice_template5] TO [public]
GO
