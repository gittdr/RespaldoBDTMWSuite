...
CREATE PROC [dbo].[d_get_tolls_sp_JR] @tollfilter char(1), @number int, @usr varchar(20) AS 
/*
INPUT PARMS:
...
GO
GRANT ALTER ON  [dbo].[d_get_tolls_sp_JR] TO [ADMINISTRADOR]
GO
GRANT EXECUTE ON  [dbo].[d_get_tolls_sp_JR] TO [ADMINISTRADOR]
GO
GRANT EXECUTE ON  [dbo].[d_get_tolls_sp_JR] TO [DIRECCION]
GO
GRANT EXECUTE ON  [dbo].[d_get_tolls_sp_JR] TO [FACTURACION]
GO
GRANT EXECUTE ON  [dbo].[d_get_tolls_sp_JR] TO [GERENCIAS]
GO
GRANT EXECUTE ON  [dbo].[d_get_tolls_sp_JR] TO [LIDER DE FLOTA]
GO
GRANT EXECUTE ON  [dbo].[d_get_tolls_sp_JR] TO [LIQUIDACIONES]
GO
GRANT CONTROL ON  [dbo].[d_get_tolls_sp_JR] TO [public]
GO
GRANT EXECUTE ON  [dbo].[d_get_tolls_sp_JR] TO [public]
GO
GRANT TAKE OWNERSHIP ON  [dbo].[d_get_tolls_sp_JR] TO [public]
GO
