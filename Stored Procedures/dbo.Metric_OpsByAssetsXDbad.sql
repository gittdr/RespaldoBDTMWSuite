...
CREATE  PROCEDURE [dbo].[Metric_OpsByAssetsXDbad]
	(
...
ELSE If @ShowDetail = 1 and @Numerator in ('EmptyMile','TravelMile')
		BEGIN
		SELECT KAM=RevType1
			,KmsCargados = dbo.fnc_TMWRN_FormatNumbers(Sum(LoadedMiles),0)
			,KmsVacios = dbo.fnc_TMWRN_FormatNumbers(Sum(EmptyMiles),0)   
...
ELSE If @ShowDetail = 2 and @Numerator in ('EmptyMile','TravelMile')
		BEGIN
		SELECT Terminal=RevType2
			,KmsCargados = dbo.fnc_TMWRN_FormatNumbers(Sum(LoadedMiles),0)
			,KmsVacios = dbo.fnc_TMWRN_FormatNumbers(Sum(EmptyMiles),0)   
...
ELSE if @ShowDetail = 3 and @Numerator in ('EmptyMile','TravelMile')
		BEGIN
...
ELSE If @ShowDetail = 4 and @Numerator in ('EmptyMile','TravelMile')
		BEGIN
		SELECT Proyecto=RevType4
			,KmsCargados = dbo.fnc_TMWRN_FormatNumbers(Sum(LoadedMiles),0)
			,KmsVacios = dbo.fnc_TMWRN_FormatNumbers(Sum(EmptyMiles),0)   
...
ELSE If @ShowDetail = 5 and @Numerator in ('EmptyMile','TravelMile')
		BEGIN
		SELECT DriverID as Operador
			,KmsCargados = dbo.fnc_TMWRN_FormatNumbers(Sum(LoadedMiles),0)
			,KmsVacios = dbo.fnc_TMWRN_FormatNumbers(Sum(EmptyMiles),0)   
...
ELSE If @ShowDetail = 6 and @Numerator in ('EmptyMile','TravelMile')
		BEGIN
		SELECT Tractor as Unidad
			,KmsCargados = dbo.fnc_TMWRN_FormatNumbers(Sum(LoadedMiles),0)
			,KmsVacios = dbo.fnc_TMWRN_FormatNumbers(Sum(EmptyMiles),0)   
...
ELSE If @ShowDetail = 8 and @Numerator in ('EmptyMile','TravelMile')
		BEGIN
		SELECT Lider
			,KmsCargados = dbo.fnc_TMWRN_FormatNumbers(Sum(LoadedMiles),0)
			,KmsVacios = dbo.fnc_TMWRN_FormatNumbers(Sum(EmptyMiles),0)   
...
ELSE If @ShowDetail = 9 and @Numerator in ('EmptyMile','TravelMile')
		BEGIN
		SELECT OrderNumber as Orden 
			,KmsCargados = dbo.fnc_TMWRN_FormatNumbers(Sum(LoadedMiles),0)
			,KmsVacios = dbo.fnc_TMWRN_FormatNumbers(Sum(EmptyMiles),0)   
...
ELSE If @ShowDetail = 10 and @Numerator in ('EmptyMile','TravelMile')
		BEGIN
		SELECT Region
			,KmsCargados = dbo.fnc_TMWRN_FormatNumbers(Sum(LoadedMiles),0)
			,KmsVacios = dbo.fnc_TMWRN_FormatNumbers(Sum(EmptyMiles),0)   
...
ELSE If @ShowDetail = 11 and @Numerator  in ('EmptyMile','TravelMile')
		BEGIN
		SELECT BillToName as Cliente
			,KmsCargados = dbo.fnc_TMWRN_FormatNumbers(Sum(LoadedMiles),0)
			,KmsVacios = dbo.fnc_TMWRN_FormatNumbers(Sum(EmptyMiles),0)   
...
ELSE If @ShowDetail = 12 and @Numerator in ('EmptyMile','TravelMile')
		BEGIN
		SELECT Flota
			,KmsCargados = dbo.fnc_TMWRN_FormatNumbers(Sum(LoadedMiles),0)
			,KmsVacios = dbo.fnc_TMWRN_FormatNumbers(Sum(EmptyMiles),0)   
...
GO
GRANT EXECUTE ON  [dbo].[Metric_OpsByAssetsXDbad] TO [public]
GO
