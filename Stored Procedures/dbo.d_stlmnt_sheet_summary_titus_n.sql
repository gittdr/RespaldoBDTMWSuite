...
CREATE PROC [dbo].[d_stlmnt_sheet_summary_titus_n](
	...
	@hld_yes varchar(3),	
	@pyhnumber int,
	@tpr_yes varchar(3),					--PTS 57522
	@tpr_id varchar(8),						--PTS 57522 
	@relcol varchar(3),
	@relncol varchar(3),
 ...
 * 
 * NAME:
 * dbo.d_stlmnt_sheet_summary_titus_n
 *
 * TYPE:
 * Stored Procedure
 *
 ...
 *
 * 08/27/2009 PTS 48785 changed retrieval of weight for split billed invocies
 * 11/04/2009 PTS 49723 SGB  An update to the temp table is overstating the YTD for current period
 * 06/14/2011 PTS 57434 PCURR An update to the temp table is overstating the YTD for current period
 * 08/20/2013 PTS 57522 Update settlement sheet to be TPR
 **/
...
/*
--BEGIN PTS 49723 SGB 11/04/09 This is overstating the YTD for current period
--Client requested change and was tested on their Live system
UPDATE #YTDBAL
...
FROM #YTDBAL yb
--END PTS 49723 SGB 11/04/09
*/

/*
--BEGIN PTS 57434 PCURR 06/14/11 This is overstating the YTD for current period
UPDATE #YTDBAL
...
-- SGB PTS 48785 use the primary invoice for weight when split billed 
WHERE ih.ivh_hdrnumber = (select min(ih2.ivh_hdrnumber) 
													from invoiceheader ih2 
													where ih2.ord_hdrnumber = #temp_pd.ord_hdrnumber)
...
GO
GRANT EXECUTE ON  [dbo].[d_stlmnt_sheet_summary_titus_n] TO [public]
GO
