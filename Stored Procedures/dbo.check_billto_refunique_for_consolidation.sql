...
CREATE PROC [dbo].[check_billto_refunique_for_consolidation] @p_ord int, @p_refnumber varchar(20), @p_typetoenforce varchar(6),
 ...
 * 
 * NAME:
 * dbo.check_billto_refunique_for_consolidation
 *
 * TYPE:
 * StoredProcedure
 *
 * DESCRIPTION:
 * Provide the mov number of the trip conflicting with the order and reference number passed
 *
 * RETURNS:
 * 0 = no mov_number 
 * >0 - mov_number   
 ...
 *       return value used to return the mov_number  if the reference number uniqueness has ben violated 
 *
...
ELSE
	BEGIN
		...
		SELECT @p_retval =  ord.mov_number 		  
	...
	END
GO
GRANT EXECUTE ON  [dbo].[check_billto_refunique_for_consolidation] TO [public]
GO
