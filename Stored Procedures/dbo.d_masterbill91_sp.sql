...
CREATE PROC [dbo].[d_masterbill91_sp] (@reprintflag varchar(10),@mbnumber int,@billto varchar(8), 
 ...
 * 
 * NAME:
 * dbo.d_masterbill91_sp
 *
 * TYPE:
 * StoredProcedure
 *
 * DESCRIPTION:
 * Return data for Masterbill 91
 *
 * RETURNS:
 * na
 *
 ...
 * 063 - ref_number1 varchar(30) null,
 * 064 - ref_number2 varchar(30) null,
 * 065 - ref_number3 varchar(30) null,
 * 066 - ref_number4 varchar(30) null,
 * 067 - ref_number5 varchar(30) null,
 * 068 - rte_ref_number varchar(30) null,
 * 069 - ivh_rateby varchar(1) null
...
@COUNT INT, @MAX_SEQUENCE INT,@REF_STRING1 VARCHAR(30),@REF_STRING2 VARCHAR(30),
@REF_STRING3 VARCHAR(30),@REF_STRING4 VARCHAR(30),@REF_STRING5 VARCHAR(30),
...
CREATE TABLE #masterbill_temp (		ord_hdrnumber int,
		...
		ref_number4 varchar(30) null,
		ref_number5 varchar(30) null,
		rte_ref_number varchar(30) null,
...
-- dpete for LOR pts4785 provide for maitlto override of billto
	...
	ivh_consignee_zip = 
		...
		invoiceheader.ivh_currency,
                --PTS33567 PRB Commented out below and added fix
		--duedate = (SELECT DATEADD(day, Convert(INT, ISNULL(cmp1.cmp_othertype1, '0')), @billdate))
		--duedate = (SELECT DATEADD(day, Convert(INT, ISNULL(cmp1.cmp_othertype1, '0')), ivh_billdate))
   ...
   WHERE	( invoiceheader.ivh_mbnumber = @mbnumber )
		...
		AND (@consignee IN (invoiceheader.ivh_consignee,'UNKNOWN'))
				...
				AND ivd_type NOT IN ('DRP','PUP','NONE') -- PTS 33921 - Moved from final select
...
-- PTS33567 PRB Added the RTEID to get proper Route back.
...
-- PTS 33921 -
/*  Moved to initial select statements.  
...
GO
GRANT EXECUTE ON  [dbo].[d_masterbill91_sp] TO [public]
GO
