...
CREATE PROC [dbo].[d_masterbill05_sp] (@reprintflag varchar(10),@mbnumber int,@billto varchar(8), 
	@tractor varchar(8),@revtype1 varchar(6), @mbstatus varchar(6),
...
-- 11/11/99 change ivd_coutn and vol to floats
...
-- dpete for LOR pts4785 provide for maitlto override of billto
      ...
      WHERE invoiceheader.ivh_billto = @billto and
            invoiceheader.ivh_tractor = @tractor and 
...
GO
GRANT EXECUTE ON  [dbo].[d_masterbill05_sp] TO [public]
GO
