...
SET ANSI_NULLS ON
GO
CREATE PROCEDURE [dbo].[ds_tar_edit_bill_accessorial_s_sp]
 ...
 *
 * NAME:
 * dbo.ds_tar_edit_bill_accessorial_s_sp
 *
 * TYPE:
 * StoredProcedure
 *
...
BEGIN
   ...
   SELECT a.tar_number              AS primary_tar_number
        ...
        , h.cht_rollintolh          AS acc_cht_rollintolh
...
END
GO
GRANT EXECUTE ON  [dbo].[ds_tar_edit_bill_accessorial_s_sp] TO [public]
GO
