...
SET ANSI_NULLS ON
GO
-- Receives a string for comparison and returns either info for ONE BILL-TO company or a list of BILL-TO companies
-- based on whether the string is to be matched exactly with company id or matched LIKE company id or name  
-- For the LIKE cases the number of rows returned is limited to: 25
-- estatGetBilltoInfo 'likeid', ''
...
GO
GRANT EXECUTE ON  [dbo].[estatGetBilltoInfo] TO [public]
GO
