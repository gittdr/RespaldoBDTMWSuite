...
CREATE PROC [dbo].[TripsSettlementOnHoldPlanningBoard_sp] (
 @status varchar(6),
 @drvyes varchar(3),  
 @trcyes varchar(3), 
 @trlyes varchar(3), 
 ...
 *
 * NAME:
 * dbo.TripsSettlementOnHoldPlanningBoard_sp
 *
 * TYPE:
 * StoredProcedure
 *
 * DESCRIPTION:
 * Proc for dw TripsSettlementOnHoldPlanningBoard_sp
 *
 * RETURNS:
 * dw result set
 *
...
DROP TABLE #trips
GO
GRANT EXECUTE ON  [dbo].[TripsSettlementOnHoldPlanningBoard_sp] TO [public]
GO
