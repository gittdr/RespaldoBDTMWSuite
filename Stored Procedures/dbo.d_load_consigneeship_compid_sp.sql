...
create proc [dbo].[d_load_consigneeship_compid_sp] 
	@comp 		varchar(8) 
	,@number	int 
as
/* Revision History:
	...
	-----------	---------------	-------	----------------------------------------------
	PTS 54076	DJM				Created this proc from d_load_consignee_compid_sp to show Consignee and Shipper companies.
*/
...
set rowcount 0 
GO
GRANT EXECUTE ON  [dbo].[d_load_consigneeship_compid_sp] TO [public]
GO
