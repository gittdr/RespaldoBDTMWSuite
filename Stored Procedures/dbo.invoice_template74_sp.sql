...
create procedure [dbo].[invoice_template74_sp](@p_invoice_nbr   int,@p_copies  int)  
as  

/**
 * 
 * NAME:
 * dbo.invoice_template74_sp
 *
 * TYPE:
 * StoredProcedure
 *
...
SELECT @v_LblRevType1 = Max( userlabelname )
FROM	labelfile
...
return @v_ret_value  
GO
GRANT EXECUTE ON  [dbo].[invoice_template74_sp] TO [public]
GO
