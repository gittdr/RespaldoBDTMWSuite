...
GO
/********
exec sp_pilgrims_cmpfreights '2018-12-01T00:00:00', '2018-12-30T23:59:00', 'PI15765-QA76000-APY15765'
...
CREATE proc [dbo].[sp_pilgrims_cmpfreights] ( @fechainicio datetime, @fechafin datetime,@token varchar(254))
...
where inv.ivh_billto =  'PILGRIMS' 
 ...
 and ord.ord_completiondate between @fechainicio and @fechafin
