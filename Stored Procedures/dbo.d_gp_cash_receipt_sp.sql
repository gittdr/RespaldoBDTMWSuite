...
create procedure [dbo].[d_gp_cash_receipt_sp] (@p_billto varchar(15), @p_reftype1 varchar(8), @p_reftype2 varchar(8), 
...
References:
 Calls001    ? NONE
 CalledBy001 ? d_gp_cash_reciept (datawindow)

NOTE:  

Revision History
09/28/05.01 Ken Mader  - Creation

9/5/12.02 Ken Mader  --  Added third method to use LinkedServer
...
create table #temp
           ([file]                 	varchar(256)	not null	default ('NO'), 
            ...
            [debit]             	char(1)     	not null	default('D'), 
            ...
            [invoice]         	varchar(17)	null, 
            [invamount_1]	money     	null, 
            [sequence]   	int               	null, 
            [type]              	int               	null, 
            [writeofftype] 	int               	null, 
            [customerid] 	varchar(15)	null, --PTS 68619   expanded to 15
            ...
            [gotfocus]      	int               	not null	default(0), 
            ...
            [refnum2]       	varchar(30)	null, --pts 33343 referencenumber field was expanded from 25 to 30
            [apply]            	char(1)       	NULL, 
...
drop table #temp
GO
GRANT EXECUTE ON  [dbo].[d_gp_cash_receipt_sp] TO [public]
GO
