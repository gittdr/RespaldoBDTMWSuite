...
CREATE PROCEDURE [dbo].[tmail_AddPayDetailHrsMiles4] (@p_sLgh varchar(10),
 ...
 * 03/20/2013 - PTS40956 - HMA - @p_Stop varchar(20) was not in use in call to 
 *                             tmail_AddPayDetailHrsMiles5. so I changed that.
 **/ 
...
EXEC dbo.tmail_AddPayDetailHrsMiles5 @p_sLgh, @p_sQuantity, @p_sHours, @p_sMiles, @p_DescPrefix, @p_asgn_type, @p_asgn_id, @p_PayType, @p_Flags, @p_TransactionDate, @p_sPayPeriod, @p_sMsgDate, @p_PaySchedulesHeaderName,@P_STOP,''
GO
GRANT EXECUTE ON  [dbo].[tmail_AddPayDetailHrsMiles4] TO [public]
GO
