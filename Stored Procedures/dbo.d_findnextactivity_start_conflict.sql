...
CREATE PROCEDURE [dbo].[d_findnextactivity_start_conflict] @asgnid varchar (13), @asgntype varchar (6), @asgndate datetime, @mov integer
AS
SET NOCOUNT ON
...
GO
GRANT EXECUTE ON  [dbo].[d_findnextactivity_start_conflict] TO [public]
GO
