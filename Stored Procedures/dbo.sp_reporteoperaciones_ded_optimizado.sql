...
--Drop Proc  sp_reporteoperaciones_ded_optimizado
--exec sp_reporteoperaciones_ded
CREATE procedure [dbo].[sp_reporteoperaciones_ded_optimizado]
AS
...
--Execute sp_TTSTMWAllocateRevVsPay_SSRS1_DED_Swat 'D',@ls_fechasabini,@ls_fechaviefin,'','','',' ','N','Y','N','CMP',' ',' ',' ',' ',' ',' ','SAY,FULO,P&G,GAM,HED','DED',' ',' ',' ',' ','N','Y',' ',' ' 
Execute sp_TTSTMWAllocateRevVsPay_SSRS1_DED_Optimizado 'D',@ls_fechasabini,@ls_fechaviefin,'','','',' ','N','Y','N','CMP',' ',' ',' ',' ',' ',' ','P&G',' ',' ',' ',' ','JG','N','Y',' ',' '
