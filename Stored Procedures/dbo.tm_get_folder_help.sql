...
CREATE PROCEDURE [dbo].[tm_get_folder_help]	
					@FolderSN INT,
					@MaxMessages INT

AS

/* 10/2/01 TD: Created to workaround SQL 2000 Insert/RowCount issue. */
...
SET NOCOUNT ON
	...
	SET ROWCOUNT 0
GO
GRANT EXECUTE ON  [dbo].[tm_get_folder_help] TO [public]
GO
