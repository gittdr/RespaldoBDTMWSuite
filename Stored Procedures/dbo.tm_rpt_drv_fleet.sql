...
CREATE PROCEDURE [dbo].[tm_rpt_drv_fleet] @IncludeRetired int
...
/*****************************************************************
*   05/05/03 MZ: Created TotalMail based Driver Fleet Report. 
*****************************************************************/
...
ORDER BY ckc_driver
GO
GRANT EXECUTE ON  [dbo].[tm_rpt_drv_fleet] TO [public]
GO
