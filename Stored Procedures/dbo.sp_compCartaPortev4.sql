...
GO
/*
Autor: Emilio Olvera y JR
Fecha: 23 May 2022 15:27 hrs
Version 4.0
...
modificacion:
Toma los cambios de la version 4.0 del CFDI
...
CREATE proc [dbo].[sp_compCartaPortev4]  @lgh_hdrnumber varchar(20)
...
--SECCION RECEPTOR (1:1)
	...
	''                                                                                                               --17 Correo electronio para envio
                                                                               +'|'+   
    'Regimen fiscal receptor'																						 --18 Regimen fiscal receptor
																			   +'|'+
