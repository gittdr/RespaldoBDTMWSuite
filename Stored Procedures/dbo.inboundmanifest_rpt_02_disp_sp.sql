...
CREATE PROC [dbo].[inboundmanifest_rpt_02_disp_sp] (@ord_number VARCHAR (12), @startdt DATETIME, @enddt DATETIME,
...
GO
GRANT EXECUTE ON  [dbo].[inboundmanifest_rpt_02_disp_sp] TO [public]
GO
