...
GO
  ...
  create procedure [dbo].[invoice_template118](@invoice_nbr   int,@copies  int)  
as  
/*
 * 
 * NAME:dbo.invoice_template118
 * 
 * TYPE:
 * StoredProcedure
 *
 ...
 * 
 * REVISION HISTORY:
 * 05/31/2007 - PTS 37063 - OS - Created 
 **/
...
GO
GRANT EXECUTE ON  [dbo].[invoice_template118] TO [public]
GO
