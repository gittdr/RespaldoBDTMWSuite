...
CREATE PROCEDURE [dbo].[d_edi214_status_bycomp_sp] @p_cmpid varchar(8) = NULL
AS

/**
 * 
 * NAME:
 * dbo.d_edi214_status_bycomp_sp
 *
 * TYPE:
 * StoredProcedure
 *
...
GO
GRANT EXECUTE ON  [dbo].[d_edi214_status_bycomp_sp] TO [public]
GO
