...
GO
  ...
  create procedure [dbo].[invoice_template154](@invoice_nbr   int,@copies  int)  
as  
...
FROM #invtemp_tbl
	INNER JOIN referencenumber as ref_special ON (ref_special.ref_tablekey = #invtemp_tbl.ord_hdrnumber AND ref_special.ref_table = 'orderheader' AND ref_special.ref_type = 'SPE#')
...
GO
GRANT EXECUTE ON  [dbo].[invoice_template154] TO [public]
GO
