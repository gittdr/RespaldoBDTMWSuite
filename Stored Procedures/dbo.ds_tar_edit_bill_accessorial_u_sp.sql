...
SET ANSI_NULLS ON
GO
CREATE PROCEDURE [dbo].[ds_tar_edit_bill_accessorial_u_sp]
 ...
 *
 * NAME:
 * dbo.ds_tar_edit_bill_accessorial_u_sp
 *
 * TYPE:
 * StoredProcedure
 *
...
BEGIN
   ...
   --Current Values from Tariffheader
   SELECT @acc_tar_rowbasis          = tar_rowbasis
        ...
        , @acc_cht_class             = cht_class
        , @acc_cht_lh_min            = cht_lh_min
        , @acc_cht_lh_rev            = cht_lh_rev
        , @acc_cht_lh_stl            = cht_lh_stl
        , @acc_cht_lh_rpt            = cht_lh_rpt
        , @acc_tar_totlh_mincharge   = tar_totlh_mincharge
        , @acc_tar_minqty            = tar_minqty
        , @acc_tar_non_billable      = tar_non_billable
        , @acc_tar_zerorateisnorate  = tar_zerorateisnorate
        , @acc_tar_external_flag     = tar_external_flag
        , @acc_tar_rowcolbasis_view  = tar_rowcolbasis_view
        , @acc_tar_maxquantity       = tar_maxquantity
        , @acc_tar_maxcharge         = tar_maxcharge
        , @acc_tar_type              = tar_type
     FROM tariffheader
    WHERE tar_number = @acc_trk_tar_number
   ...
   UPDATE tariffheader
      SET tar_description        = @acc_tar_description
        ...
        , cht_class              = @acc_cht_class
        , cht_lh_min             = @acc_cht_lh_min
        , cht_lh_rev             = @acc_cht_lh_rev
        , cht_lh_stl             = @acc_cht_lh_stl
        , cht_lh_rpt             = @acc_cht_lh_rpt
        , tar_totlh_mincharge    = @acc_tar_totlh_mincharge
        , tar_minqty             = @acc_tar_minqty
        , tar_non_billable       = @acc_tar_non_billable
        , tar_zerorateisnorate   = @acc_tar_zerorateisnorate
        , tar_external_flag      = @acc_tar_external_flag
        , tar_rowcolbasis_view   = @acc_tar_rowcolbasis_view
        , tar_maxquantity        = @acc_tar_maxquantity
        , tar_maxcharge          = @acc_tar_maxcharge
        , tar_type               = @acc_tar_type
    WHERE tar_number = @acc_trk_tar_number
...
END
GO
GRANT EXECUTE ON  [dbo].[ds_tar_edit_bill_accessorial_u_sp] TO [public]
GO
