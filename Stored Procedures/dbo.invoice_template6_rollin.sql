...
GO
  ...
  CREATE PROCEDURE [dbo].[invoice_template6_rollin](@invoice_nbr   int,@copies int)  
AS  
...
26523  copied from invoice_template2_rollin to add carrier type 4
...
GO
GRANT EXECUTE ON  [dbo].[invoice_template6_rollin] TO [public]
GO
