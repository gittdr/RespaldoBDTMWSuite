...
CREATE PROC [dbo].[d_masterbill134_sp] (	@reprintflag varchar(10), @mbnumber int, @billto varchar(8),   
...
/**		REVISION HISTORY:
		PTS45203 JSwindell 2-11-2009 NEW MB 134 CREATED (using mb55 as template) 
		PTS47380 JSwindell 5-7-2009  Client wants Consignee name instead of city/state when break on SHIPPER only.
...
GO
GRANT EXECUTE ON  [dbo].[d_masterbill134_sp] TO [public]
GO
