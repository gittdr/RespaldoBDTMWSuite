...
Create Procedure [dbo].[d_StlFinalPayDetails_custom_sp]  (@phnum INT, @type CHAR(6), @id CHAR(13), @paydate DATETIME)
AS
...
/* Revision History:
	...
	12/18/12	JSwindell	PTS 66293   Created.  ( Enhancment for 60458 functionality )	
...
GO
GRANT EXECUTE ON  [dbo].[d_StlFinalPayDetails_custom_sp] TO [public]
GO
