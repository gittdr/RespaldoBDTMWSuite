...
--Drop Proc  sp_reporteoperaciones_Esp
--exec sp_reporteoperaciones_Esp
CREATE procedure [dbo].[sp_reporteoperaciones_Esp]
AS
...
--Execute sp_TTSTMWAllocateRevVsPay_SSRS1_Esp 'D',@ls_fechasabini,@ls_fechaviefin,'','','',' ','N','Y','N','CMP',' ',' ',' ',' ',' ',' ',' ','ESP',' ',' ',' ',' ','N','Y',' ',' '
Execute sp_TTSTMWAllocateRevVsPay_SSRS1_Esp 'D',@ls_fechasabini,@ls_fechaviefin,'','','',' ','N','Y','N','CMP',' ',' ',' ',' ',' ',' ','QRL,EUC,FULS,TOL,ABI',' ',' ',' ',' ',' ','N','Y',' ',' '
Delete from MR_SessionID where ses_SPID=@@SPID 
