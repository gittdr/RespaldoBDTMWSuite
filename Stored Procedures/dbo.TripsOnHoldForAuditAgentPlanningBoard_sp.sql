...
CREATE PROC [dbo].[TripsOnHoldForAuditAgentPlanningBoard_sp] (
 @status varchar(6),
 @drvyes varchar(3),  
 @trcyes varchar(3), 
 @trlyes varchar(3), 
 ...
 *
 * NAME:
 * dbo.TripsOnHoldForAuditAgentPlanningBoard_sp
 *
 * TYPE:
 * StoredProcedure
 *
 * DESCRIPTION:
 * Proc for dw TripsOnHoldForAuditAgentPlanningBoard_sp
 *
 * RETURNS:
 * dw result set
 *
...
-- PTS 93267 | 2015/07/30 | KARAW - Create Trips On for Audit Planning Board
-- PTS 93273 | 2015/09/1  | GulabT - Filter out trips from queue that are not related to Agent Pay
...
DROP TABLE #trips
GO
GRANT EXECUTE ON  [dbo].[TripsOnHoldForAuditAgentPlanningBoard_sp] TO [public]
GO
