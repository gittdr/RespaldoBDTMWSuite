...
CREATE PROC [dbo].[d_loadtrc_with_inactive_sp] @trc varchar(8) , @number int, @parmlist varchar(254) AS
/**
 * 
 * NAME:
 * dbo.d_loadtrc_with_inactive_sp 
 *
 * TYPE:
 * Stored Procedure
 *
...
GO
GRANT EXECUTE ON  [dbo].[d_loadtrc_with_inactive_sp] TO [public]
GO
