...
CREATE PROC [dbo].[d_masterbill103_sp] (@reprintflag varchar(10),@mbnumber int,@billto varchar(8), 
...
GO
GRANT EXECUTE ON  [dbo].[d_masterbill103_sp] TO [public]
GO
