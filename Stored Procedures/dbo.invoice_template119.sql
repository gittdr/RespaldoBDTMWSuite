...
create procedure [dbo].[invoice_template119](@invoice_nbr int,@copies int)  
as 
/*
*
* 
* NAME:invoice_template119
* dbo.invoice_template119
*
* TYPE:
* StoredProcedure
*
 ...
 * PTS47432 5/28/09 DPETE support rollinto LH
*/
...
SELECT  invoiceheader.ivh_invoicenumber,
	...
	1 copies,  
	chargetype.cht_basis cht_basis,  
...
/* add variables @rollintolhamount money ,
 @ratefactor float,
 @unit varchar(6),
 @rateunit varchar(6)
*/ 
...
If @rollintolhamount <> 0 and exists (select 1 from invoiceheader where ivh_hdrnumber = @invoice_nbr
  ...
  set ivh_billto_name = company.cmp_name,  
   ...
   cmp_contact = company.cmp_contact,
	ivh_billto_misc1 = company.cmp_misc1  
...
GO
GRANT EXECUTE ON  [dbo].[invoice_template119] TO [public]
GO
