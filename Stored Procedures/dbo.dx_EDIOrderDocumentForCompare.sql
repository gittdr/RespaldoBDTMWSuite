...
CREATE PROCEDURE [dbo].[dx_EDIOrderDocumentForCompare]
...
insert @dx_archive(dx_importid, dx_sourcename, dx_sourcedate, dx_updated, dx_accepted, 
		...
		dx_field029, dx_field030, dx_billto, dx_trpid, dx_archive_header_id
		)
	SELECT 
		dx_importid, dx_sourcename, dx_sourcedate, dx_updated, dx_accepted, 
		dx_ordernumber, 
	...
	select 
		...
		dx_createdby,dx_createdate,dx_updatedby,dx_updatedate, dx_archive_header_id
		from @dx_archive order by dx_seq
GO
GRANT EXECUTE ON  [dbo].[dx_EDIOrderDocumentForCompare] TO [public]
GO
