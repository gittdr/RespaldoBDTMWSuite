...
CREATE PROCEDURE [dbo].[tm_rpt_drv_unitsnear2] @SysTZHrs int,
										 @SysTZMin int,
										 @SysDSTCode int,
										 @UsrTZHrs int,
										 @UsrTZMin int,
...
/*****************************************************************
* 05/06/03 MZ: Created driver based TotalMail Units Near Report. 
*****************************************************************/
...
ORDER BY ckc_driver
GO
GRANT EXECUTE ON  [dbo].[tm_rpt_drv_unitsnear2] TO [public]
GO
