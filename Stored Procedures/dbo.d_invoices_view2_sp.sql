...
/****** Object:  Stored Procedure dbo.d_invoices_view2_sp    Script Date: 6/1/99 11:54:15 AM ******/
/*
...
CREATE PROC [dbo].[d_invoices_view2_sp] (@status VARCHAR(6), @billto VARCHAR(8),
...
-- return the trltype3 column value (for flarock indicates tank, dump, flatbed) 
	...
	SET	i.trltype3 =  t.trl_type3 
	FROM	Trailerprofile t, #invview i
	Where	t.trl_number = i.ivh_trailer
...
-- Count the commodities which match to the edicommodity table
	...
	UPDATE 	#invview
	SET	i.refnumber = r.ref_number
	FROM	#invview i, referencenumber r
...
SELECT * from #invview
GO
GRANT EXECUTE ON  [dbo].[d_invoices_view2_sp] TO [public]
GO
