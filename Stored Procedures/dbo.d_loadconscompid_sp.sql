...
-- this proc created to provide a list of consignee companies
-- only for the consignee company dddw 
--

create PROC [dbo].[d_loadconscompid_sp] @comp varchar(8) , @number int AS
...
GO
GRANT EXECUTE ON  [dbo].[d_loadconscompid_sp] TO [public]
GO
