...
--Execute sp_TTSTMWAllocateRevVsPay_SSRS1_ABI_lider 'D','20120310','20120310 23:59:59','','','',' ','Y','Y','N','STD,CMP,AVL',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ','N','Y',' ',' '

create procedure [dbo].[sp_TTSTMWAllocateRevVsPay_SSRS1_ABI_cliente_diario]
	(
...
delete LegHeaderSummary_SSRS_Abi_VentasClienteDia;


Insert LegHeaderSummary_SSRS_Abi_VentasClienteDia (ord_hdrnumber,
...
revtype1, revtype2, revtype3, revtype4, mpp_type1, mpp_type2, mpp_type3, mpp_type4, FirstBillTo )
Select ord_hdrnumber, 
lgh_tractor, lgh_primary_trailer, mov_number, lgh_number, LoadedMlsMove,MTMlsMove,
TotMlsMove,LoadedMlsLegHeader,MTMlsLegHeader, TotMlsLegHeader,TotLHChargeForMove,AccChargeMove,
AllChargesMove,PercentLghMlsOfMoveMls,AllocatedLHChargeForLgh,AllocatedAcclChargeForLgh,AllocatedTotlChargesForLgh,
RevPerMileAllCharges,RevPerMileLHCharge,AllocRevMinusPay,  AllocRevMinusPayPerTrvlMile,mpp_teamleader,
lgh_class1, lgh_class2, lgh_class3, lgh_class4, mpp_type1, mpp_type2, mpp_type3, mpp_type4, FirstBillTo
from #LegHeaderSummary 
order by mov_number, lgh_startdate
