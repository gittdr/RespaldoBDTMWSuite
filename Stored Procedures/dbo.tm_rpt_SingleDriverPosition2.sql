...
CREATE PROCEDURE [dbo].[tm_rpt_SingleDriverPosition2] @DriverName varchar(50),
													@IncludeRetired int,
													@SysTZHrs int,
													@SysTZMin int,
													@SysDSTCode int,
...
/****************************************************************
* 05/05/05 MZ: TotalMail based Single driver position 
****************************************************************/
...
FROM dbo.#Fleet
GO
GRANT EXECUTE ON  [dbo].[tm_rpt_SingleDriverPosition2] TO [public]
GO
