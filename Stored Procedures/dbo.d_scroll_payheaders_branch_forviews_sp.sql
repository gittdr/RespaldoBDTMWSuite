...
create PROC [dbo].[d_scroll_payheaders_branch_forviews_sp]    (
               @hold_hld   char(3),
               @released_pnd  char(3),
 ...
 *
 * NAME@
 * dbo.d_scroll_payheaders_branch_forviews_sp
 *
 * TYPE@
 * StoredProcedure
 *
...
WHERE   ( payheader.pyh_payperiod between @LoPayDate and @HiPayDate )
   ...
   and ( @lgh_booked_revtype1 = 'UNKNOWN' or @lgh_booked_revtype1 =  IsNull(manpowerprofile.mpp_branch, 'UNKNOWN') or
         @lgh_booked_revtype1 = '%' or CHARINDEX( ',' + IsNull(manpowerprofile.mpp_branch, 'UNKNOWN') + ',',@lgh_booked_revtype1) > 0)
   --BEGIN PTS 65645 SPN
...
WHERE ( payheader.pyh_payperiod between @LoPayDate and @HiPayDate )
   ...
   and ( @lgh_booked_revtype1 = 'UNKNOWN' or @lgh_booked_revtype1 =  IsNull(trc_branch, 'UNKNOWN') or
         @lgh_booked_revtype1 = '%' or CHARINDEX( ',' + IsNull(trc_branch, 'UNKNOWN') + ',',@lgh_booked_revtype1) > 0)
   --BEGIN PTS 65645 SPN
...
WHERE ( payheader.pyh_payperiod between @LoPayDate and @HiPayDate )
   ...
   AND dbo.RowRestrictByAsgn (payheader.asgn_type, payheader.asgn_id) = 1
   and ( @lgh_booked_revtype1 = 'UNKNOWN' or @lgh_booked_revtype1 =  IsNull(car_branch, 'UNKNOWN') or
         @lgh_booked_revtype1 = '%' or CHARINDEX( ',' + IsNull(car_branch, 'UNKNOWN') + ',',@lgh_booked_revtype1) > 0)
   --BEGIN PTS 65645 SPN
...
WHERE ( payheader.pyh_payperiod between @LoPayDate and @HiPayDate )
   ...
   and ( @lgh_booked_revtype1 = 'UNKNOWN' or @lgh_booked_revtype1 =  IsNull(trl_branch, 'UNKNOWN') or
         @lgh_booked_revtype1 = '%' or CHARINDEX( ',' + IsNull(trl_branch, 'UNKNOWN') + ',',@lgh_booked_revtype1) > 0)
   --BEGIN PTS 65645 SPN
...
AND ( payheader.pyh_paystatus in ( @hold_hld, @released_pnd, @collected_col, @closed_rel ) )
   ...
   and ( @lgh_booked_revtype1 = 'UNKNOWN' or @lgh_booked_revtype1 =  IsNull(tpr_branch, 'UNKNOWN') or
         @lgh_booked_revtype1 = '%' or CHARINDEX( ',' + IsNull(tpr_branch, 'UNKNOWN') + ',',@lgh_booked_revtype1) > 0)

order by payheader.pyh_payperiod, payheader.pyh_paystatus, payheader.asgn_type, payheader.asgn_id, payheader.pyh_pyhnumber

GO
GRANT EXECUTE ON  [dbo].[d_scroll_payheaders_branch_forviews_sp] TO [public]
GO
