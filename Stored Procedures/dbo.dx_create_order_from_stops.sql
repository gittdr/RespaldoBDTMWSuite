...
CREATE       proc [dbo].[dx_create_order_from_stops]  
...
END
 ...
 INSERT INTO orderheader 
    ...
    ord_revenue_pay, ord_booked_revtype1, ord_carrier)
VALUES ( @orderby_cmpid, @@ord_number, ISNULL(@ls_ord_customer,'UNKNOWN'), 	        	--1
	...
	CASE @ord_rateby WHEN 'T' THEN ISNULL(@ord_charge,0) ELSE null END, @ord_revtype1, 'UNKNOWN')
...
GO
GRANT EXECUTE ON  [dbo].[dx_create_order_from_stops] TO [public]
GO
