...
create PROCEDURE [dbo].[pod_format04_respaldo] (@ord_hdrnumber 	INTEGER) 
AS
...
-- JR Cuando la empresa requiera que la carta porte salga con monto ceros se pone aqui
UPDATE #temp
Set billto_credit_terms = '', rate = 0.00, 
charge = 0.00, ord_accessorial_chrg = 0.00, toll_charge = 0.00, iva_tax = 0.00, retention_tax = 0.00
WHERE #temp.ord_billto in( 'UNIVRSAL')
