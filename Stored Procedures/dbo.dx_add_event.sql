...
CREATE   procedure [dbo].[dx_add_event]
	@stp_number int,
	@event varchar(6),
...
SELECT ord_hdrnumber, stp_number, @event, @@evt_number, evt_startdate, evt_enddate,
	 evt_status, evt_earlydate, evt_latedate, evt_weight, evt_weightunit, fgt_number, 
	 evt_count, evt_countunit, evt_volume, evt_volumeunit, evt_pu_dr, @evt_sequence, 'UNKNOWN',
...
GO
GRANT EXECUTE ON  [dbo].[dx_add_event] TO [public]
GO
