...
CREATE PROC [dbo].[d_settlement_sheet_summary92](
 ...
 * 4/24/08 BDH PTS 41466.  Created this proc from d_settlement_sheet_summary_new
 *
 **/
...
-- PTS 29303 -- BL (end)	
	...
	start_state		char(6) null,
	end_city		varchar(18) null,
	end_state		char(6) null,
	lgh_count		int null,
...
UPDATE #temp_pd
   SET ord_startdate = oh.ord_startdate,
       ord_number = oh.ord_number,
		ord_revtype4 = oh.ord_revtype4   -- new for 41466
  FROM #temp_pd tp, 
       orderheader oh
...
update #temp_pd
set revtype4_name = labelfile.name
from labelfile 
where #temp_pd.ord_revtype4 = labelfile.abbr and ltrim(rtrim(labelfile.labeldefinition)) = 'revtype4'
...
GO
GRANT EXECUTE ON  [dbo].[d_settlement_sheet_summary92] TO [public]
GO
