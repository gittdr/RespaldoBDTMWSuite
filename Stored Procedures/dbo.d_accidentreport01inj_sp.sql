...
Create Proc [dbo].[d_accidentreport01inj_sp] @srpid int 
As
/**
 * DESCRIPTION:
 *
 ...
 *
 * REVISION HISTORY:
   SR 17782 DPETE created 12/10/03 For subreport of d_accidentreport01_sp with injuries
...
GO
GRANT EXECUTE ON  [dbo].[d_accidentreport01inj_sp] TO [public]
GO
