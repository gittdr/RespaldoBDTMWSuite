...
SET ANSI_NULLS OFF
GO
CREATE PROCEDURE [dbo].[fa_get_driver2_card] (@driver varchar (13), @tractor varchar (13), @cardnumber varchar (20) OUTPUT, @accountid varchar (10) OUTPUT, @customerid varchar(10) OUTPUT, @security varchar (20) OUTPUT)
AS 
BEGIN
...
END
GO
GRANT EXECUTE ON  [dbo].[fa_get_driver2_card] TO [public]
GO
