...
CREATE PROC [dbo].[d_settlement_sheet_summary_ref](
...
-- LOR PTS# 6879  make holdback pay the last item on the settlement sheet
UPDATE #temp_pd
   SET itemsection = 5
FROM	#temp_pd t, stdmaster s
 WHERE t.pyt_itemcode = s.pyt_itemcode and
       s.sdm_payback = 'Y'
-- LOR
...
GO
GRANT EXECUTE ON  [dbo].[d_settlement_sheet_summary_ref] TO [public]
GO
