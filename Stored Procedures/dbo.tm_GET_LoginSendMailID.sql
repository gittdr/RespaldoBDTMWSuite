...
Create PROCEDURE [dbo].[tm_GET_LoginSendMailID]
...
SELECT LoginName, EmailFolderID, AfterEmailSend 
FROM dbo.tblLogin
WHERE AlternateID = @DefaultAltID
AND UseAdminMailBox = @AdminMailBox

GO
GRANT EXECUTE ON  [dbo].[tm_GET_LoginSendMailID] TO [public]
GO
