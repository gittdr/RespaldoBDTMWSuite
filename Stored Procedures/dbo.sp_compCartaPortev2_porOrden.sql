...
26 Abr 2022 se modifica para que se timbre por numero de orden --JR
...
CREATE proc [dbo].[sp_compCartaPortev2_porOrden]  @ord_hdrnumber integer
...
select @lgh_hdrnumber = isnull(min(lgh_number),0) from legheader where ord_hdrnumber = @ord_hdrnumber and lgh_outstatus = 'STD'
...
--SECION HEADER (1:1)
    ...
    '01'                                                                                                             --1 Tipo de Registro   (R)
																		       +'|'+ 
    'TDRZP' + cast(@ord_hdrnumber  as varchar(20))                                                             --2 ID comrpobante  (R)
																	           +'|'+     
    'TDRZP'                                                                                                          --3 Serie (R)     
																	           +'|'+     
    cast(@ord_hdrnumber  as varchar(20))                                                                       --4 Folio Num  (R)
																	           +'|'+     
