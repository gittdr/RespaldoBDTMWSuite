...
CREATE PROC [dbo].[SSRS_RB_MB_01] (@reprintflag VARCHAR(10), @mbnumber INT, @ivh_billto VARCHAR(8),
					@ivh_revtype1 VARCHAR(6), @ivh_revtype2 VARCHAR(6), @ivh_revtype3 VARCHAR(6), @ivh_revtype4 VARCHAR(6), @status VARCHAR(6),
...
IF @status <> 'RTP' SELECT @reprINTflag = 'REPRINT'
...
GO
GRANT EXECUTE ON  [dbo].[SSRS_RB_MB_01] TO [public]
GO
