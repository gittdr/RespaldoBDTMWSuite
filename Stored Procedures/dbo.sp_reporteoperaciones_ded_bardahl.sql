...
create procedure [dbo].[sp_reporteoperaciones_ded_bardahl]
AS
...
Execute sp_TTSTMWAllocateRevVsPay_SSRS1_DED_Optimizado 'D',@ls_fechasabini,@ls_fechaviefin,'','','',' ','N','Y','N','CMP',' ',' ',' ',' ',' ',' ','PAC',' ',' ',' ',' ','JG','N','Y',' ',' '
