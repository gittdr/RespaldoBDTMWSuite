...
SET ANSI_NULLS ON
GO
CREATE PROCEDURE [dbo].[tmail_rpt_drv_fleet2] @IncludeRetired int,
											@SysTZHrs int,
											@SysTZMin int,
											@SysDSTCode int,
											@UsrTZHrs int,
...
-- 05/05/03 MZ: Created time zone driver based fleet report
...
ORDER BY ckc_driver
GO
GRANT EXECUTE ON  [dbo].[tmail_rpt_drv_fleet2] TO [public]
GO
