...
SET ANSI_NULLS ON
GO
CREATE PROCEDURE [dbo].[ds_tar_edit_stl_accessorial_i_sp]
 ...
 *
 * NAME:
 * dbo.ds_tar_edit_stl_accessorial_i_sp
 *
 * TYPE:
 * StoredProcedure
 *
...
BEGIN
   ...
   --Default Values for TariffheaderStl
   ...
   INSERT INTO tariffaccessorialstl
   ( tar_number
   , trk_number
   , taa_seq
   )
...
END
GO
GRANT EXECUTE ON  [dbo].[ds_tar_edit_stl_accessorial_i_sp] TO [public]
GO
