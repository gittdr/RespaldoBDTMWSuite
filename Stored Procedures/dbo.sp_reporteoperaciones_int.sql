...
--Drop Proc  sp_reporteoperaciones_int
--exec sp_reporteoperaciones_int
CREATE procedure [dbo].[sp_reporteoperaciones_int]
AS
...
Execute sp_TTSTMWAllocateRevVsPay_SSRS1 'D',@ls_fechasabini,@ls_fechaviefin,'','','',' ','N','Y','N','CMP',' ',' ',' ','INT',' ',' ',' ',' ',' ',' ',' ',' ','N','Y',' ',' ' 
Delete from MR_SessionID where ses_SPID=@@SPID 
