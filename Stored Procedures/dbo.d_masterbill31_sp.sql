...
create   PROC [dbo].[d_masterbill31_sp] (@reprintflag varchar(10),@mbnumber int,@billto varchar(8),   
 ...
 *
 * REVISION HISTORY:
 Pts 16444 Created by pchic 12/16/02
...
-- PTS 23150 -- BL (end)
  ...
  and (gi.gi_name = 'FuelSurchargeRate')  
...
GO
GRANT EXECUTE ON  [dbo].[d_masterbill31_sp] TO [public]
GO
