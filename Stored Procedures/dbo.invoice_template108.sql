...
GO
  ...
  create procedure [dbo].[invoice_template108](@invoice_nbr   int,@copies  int)  
as  
...
from  #invtemp_tbl, stops LEFT OUTER JOIN city ON stops.stp_city = city.cty_code  --pts50169 outer join conversion
...
GO
GRANT EXECUTE ON  [dbo].[invoice_template108] TO [public]
GO
