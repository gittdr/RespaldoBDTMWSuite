...
CREATE PROC [dbo].[d_masterbill25_sp] (@reprintflag varchar(10),@mbnumber int,@billto varchar(8), 
...
-- dpete for LOR pts4785 provide for maitlto override of billto
  ...
  delete from #masterbill_temp where cht_primary <> 'Y' and ivd_charge = 0 
  SELECT * 
...
GO
GRANT EXECUTE ON  [dbo].[d_masterbill25_sp] TO [public]
GO
