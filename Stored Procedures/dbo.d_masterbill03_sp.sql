...
Create  PROC [dbo].[d_masterbill03_sp] (@reprintflag varchar(10),@mbnumber int,@billto varchar(8), 
 ...
 * 11/17/09 PTS 49893 Master bill does ntoprint credit memos
 **/
...
-- dpete for LOR pts4785 provide for maitlto override of billto
	...
	--ILB 10-18-2002 PTS# 15194
    --JG 10-29-07 PTS40029, outer join conversion
...
-- dpete for LOR pts4785 provide for maitlto override of billto
   ...
   --  AND    (@revtype1 in (invoiceheader.ivh_revtype1,'UNK')) 
     ...
     AND    (cty1.cty_code = invoiceheader.ivh_origincity) 
     AND    (cty2.cty_code = invoiceheader.ivh_destcity)
    -- 49893  AND    (ivd.ivd_volume > 0 OR ivd_quantity > 0)
 AND    (ivd.ivd_volume <> 0 OR ivd_quantity <> 0)
  END
...
GO
GRANT EXECUTE ON  [dbo].[d_masterbill03_sp] TO [public]
GO
