...
CREATE PROCEDURE [dbo].[invoice_template55_rollin](@invoice_nbr   int,@copies int)  
AS  
...
--this was commented out because Koch wants the info to pull from the comapny profile rather
--than the city profile  
...
--     stop_nmctst = substring(cmp.cty_nmstct,1, (charindex('/', cmp.cty_nmstct)))+ ' ' + IsNull(cmp.cmp_zip,'')   
...
RETURN @ret_value 
GO
GRANT EXECUTE ON  [dbo].[invoice_template55_rollin] TO [public]
GO
