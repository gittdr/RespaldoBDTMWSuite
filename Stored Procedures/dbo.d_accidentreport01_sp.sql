...
Create Proc [dbo].[d_accidentreport01_sp] @srpid int 
As
/**
 * DESCRIPTION:
 *
 ...
 *
 * REVISION HISTORY:
   SR 17782 DPETE created 12/10/03
   PTS 21787 add insurance info to safetyreport
...
GO
GRANT EXECUTE ON  [dbo].[d_accidentreport01_sp] TO [public]
GO
