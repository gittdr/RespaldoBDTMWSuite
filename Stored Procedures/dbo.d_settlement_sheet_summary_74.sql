...
CREATE PROC [dbo].[d_settlement_sheet_summary_74](
 ...
 * 
 * NAME:
 * dbo.d_settlement_sheet_summary_74
 *
 * TYPE:
 * Stored Procedure
 *
 * DESCRIPTION:
 * exact copy of d_settlement_sheet_summary_new before it was
 * changed on TPS 35817
 *
 * RETURNS:
 * See selection list.
 * 
 ...
 *
 * REVISION HISTORY:
 * 01/15/2007.01 PTS35817 - Vince Herman - copy from _new
...
-- PTS 29515 -- BL (start)
	pyt_basis
-- PTS 29515 -- BL (end)
  FROM #temp_pd tp LEFT OUTER JOIN payheader ph ON tp.pyh_number = ph.pyh_pyhnumber  --pts40116

GO
GRANT EXECUTE ON  [dbo].[d_settlement_sheet_summary_74] TO [public]
GO
