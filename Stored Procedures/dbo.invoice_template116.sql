...
GO
  ...
  create procedure [dbo].[invoice_template116](@invoice_nbr   int,@copies  int)  
as  

/*
 * 
 * NAME:invoice_template116
 * dbo.
 *
 * TYPE:
 * StoredProcedure
 *
 * DESCRIPTION:
 * Provide a return SET of all details for an invoice.
 * 
 *
 * RETURNS:
 ...
 * 
 * REVISION HISTORY:
 * 08/16/2007.01 - PTS37497 - MK/EMK - Created new stored procedure for Invoice format 116 (derived from invoice_template2)
...
GO
GRANT EXECUTE ON  [dbo].[invoice_template116] TO [public]
GO
