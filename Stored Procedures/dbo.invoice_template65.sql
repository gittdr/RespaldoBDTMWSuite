...
create procedure [dbo].[invoice_template65](@invoice_nbr int,@copies int)  
as  
...
* PTS 52079 SGB Add isnull 'UNKNOWN' to ivd_description 
*/  
...
while @counter <>  @copies  
 ...
 select @counter = @counter + 1  
  ...
  dest_nmctst,  
         ...
         ivd_number,     
         stp_number,     
         isnull(ivd_description,'UNKNOWN') as ivd_description,     -- PTS 52079 SGB 04/28/2010
         cht_itemcode,     
         ivd_quantity,     
         ivd_rate,     
         ivd_charge,     
...
GO
GRANT EXECUTE ON  [dbo].[invoice_template65] TO [public]
GO
