 ...
 * 01/11/07      - 38187    - DWG - Added Flags and SeparateOnFields parameters, created tmail_commodity3
 *
 **/
...
CREATE PROCEDURE [dbo].[tmail_commodity2] @stop_nbr_parm varchar(200),
                                      @fgt_sequence_parm varchar(20)

AS

EXEC tmail_commodity3 @stop_nbr_parm,
                      @fgt_sequence_parm,
					  '0',
					  ''

GO
GRANT EXECUTE ON  [dbo].[tmail_commodity2] TO [public]
GO
