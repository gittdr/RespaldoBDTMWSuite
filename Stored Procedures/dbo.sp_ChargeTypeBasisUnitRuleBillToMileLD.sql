...
CREATE PROC [dbo].[sp_ChargeTypeBasisUnitRuleBillToMileLD]
( @TarNumber      INT
, @TariffInputId  INT
, @OrdHdrNumber   INT
) AS
 ...
 *
 * NAME:
 * dbo.sp_ChargeTypeBasisUnitRuleBillToMileLD
 *
 * TYPE:
 * StoredProcedure
 *
...
END
GO
GRANT EXECUTE ON  [dbo].[sp_ChargeTypeBasisUnitRuleBillToMileLD] TO [public]
GO
