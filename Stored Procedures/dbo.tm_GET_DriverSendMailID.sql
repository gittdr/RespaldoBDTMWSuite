...
Create PROCEDURE [dbo].[tm_GET_DriverSendMailID]
...
SELECT Name, EmailFolderID, AfterEmailSend 
FROM dbo.tblDrivers
...
GO
GRANT EXECUTE ON  [dbo].[tm_GET_DriverSendMailID] TO [public]
GO
