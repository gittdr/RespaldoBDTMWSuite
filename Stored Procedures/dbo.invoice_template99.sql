...
CREATE procedure [dbo].[invoice_template99](@p_invoice_nbr int,@p_copies  int)  
as  

/*
 * 
 * NAME:invoice_template99
 * dbo.
 *
 * TYPE:
 * StoredProcedure
...
SET	orderby_name = company.cmp_name,
	orderby_nmctst = SUBSTRING(company.cty_nmstct, 1, @li_pos),
...
UPDATE 	#invtemp_tbl  
SET 	consignee_name = CASE company.cmp_name WHEN 'UNKNOWN' THEN NULL ELSE company.cmp_name END,
...
GO
GRANT EXECUTE ON  [dbo].[invoice_template99] TO [public]
GO
