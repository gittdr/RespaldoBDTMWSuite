...
SET ANSI_NULLS ON
GO
CREATE PROCEDURE [dbo].[tmail_rpt_unitsnear3] @SysTZHrs int,
					 @SysTZMin int,
					 @SysDSTCode int,
					 @UsrTZHrs int,
					 @UsrTZMin int,
 ...
 * 11/27/01 MZ:  Added time zone conversion calls in new vesion (3)
...
FROM #UnitsNear
GO
GRANT EXECUTE ON  [dbo].[tmail_rpt_unitsnear3] TO [public]
GO
