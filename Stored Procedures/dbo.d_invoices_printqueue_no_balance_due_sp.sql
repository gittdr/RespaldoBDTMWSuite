...
/*
  ...
  NEW PROC  (for Express Leasing)
	(copied and modified from 'd_invoices_printqueue2_sp')
...
CREATE  PROC [dbo].[d_invoices_printqueue_no_balance_due_sp] (@status VARCHAR(6), @billto VARCHAR(8),
...
GO
GRANT EXECUTE ON  [dbo].[d_invoices_printqueue_no_balance_due_sp] TO [public]
GO
