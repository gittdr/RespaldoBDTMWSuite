...
CREATE PROC [dbo].[rpt_crst_user_task_total_by_type] (
...
SELECT
  ASSIGNED_USER,
  ACTIVITY_TYPE,
  (SELECT name from labelfile where labeldefinition = 'TaskActivity' and abbr = ACTIVITY_TYPE) as [TYPE_DESC],
...
GROUP BY ASSIGNED_USER, ACTIVITY_TYPE

GO
GRANT EXECUTE ON  [dbo].[rpt_crst_user_task_total_by_type] TO [public]
GO
