...
CREATE PROCEDURE [dbo].[d_view_commodity_last_sp] (@stringparm VARCHAR(13), @numberparm INT, @retrieveby CHAR(3))
AS
/*

DPETE 27846 installing performance enhancement found by Keith
DPETE 43225 change name of proc (change _sp2 to _sp). Add REQUIRES 41420
...
END
GO
GRANT EXECUTE ON  [dbo].[d_view_commodity_last_sp] TO [public]
GO
