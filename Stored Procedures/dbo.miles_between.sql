    ...
    BEGIN     
        ...
        where		(( mileagetable.mt_origintype = 'C' ) AND  
                 ...
                 */
                 ...
                 ( mileagetable.mt_destination = CONVERT( VARCHAR( 10 ), @d_cty) ) AND 
                 ( mileagetable.mt_type = @type ) AND
                 (IsNull (mileagetable.mt_haztype,0) = @haztype )
                 AND @bidirectional_miles = 'Y') /* 11/11/2013 MDH PTS 73308: Added correct reverse check */
        ...
        where		(( mileagetable.mt_origintype = 'Z' ) AND  
                 ( mileagetable.mt_origin =  @o_zip) AND  
                 ( mileagetable.mt_destinationtype = 'O' ) AND  
...
GO
GRANT EXECUTE ON  [dbo].[miles_between] TO [public]
GO
