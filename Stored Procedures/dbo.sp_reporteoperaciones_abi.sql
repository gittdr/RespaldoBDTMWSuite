...
--Drop Proc  sp_reporteoperaciones_abi
--exec sp_reporteoperaciones_abi
CREATE procedure [dbo].[sp_reporteoperaciones_abi]
AS
...
Execute sp_TTSTMWAllocateRevVsPay_SSRS1_ABI 'D',@ls_fechasabini,@ls_fechaviefin,'','','',' ','N','Y','N','CMP',' ',' ','BAJ',' ',' ',' ',' ',' ',' ',' ',' ',' ','N','Y',' ',' '
Delete from MR_SessionID where ses_SPID=@@SPID 
