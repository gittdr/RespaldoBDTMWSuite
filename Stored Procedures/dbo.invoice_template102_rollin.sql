...
CREATE PROCEDURE [dbo].[invoice_template102_rollin](@invoice_nbr   int,@copies int)  
AS  
set nocount on
 ...
 * 
 * NAME:
 * dbo.invoice_template102_rollin
 *
 * TYPE:
 * StoredProcedure
 *
...
return @ret_value
GO
GRANT EXECUTE ON  [dbo].[invoice_template102_rollin] TO [public]
GO
