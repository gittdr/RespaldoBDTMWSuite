...
CREATE PROCEDURE [dbo].[ResNowOV_R1_Revenue_Class_4]
...
*/
	...
	BEGIN
		...
		SELECT 		[LastUpdate] = GETDATE(),
				...
				[ItemCategory] = @Mode,
				[ItemID] = ord_RevType4, 
				[ItemDescription] = (SELECT name FROM labelfile (NOLOCK) where labeldefinition = 'RevType4' and abbr = ord_RevType4),
				[Count] = COUNT(*),
...
GO
GRANT EXECUTE ON  [dbo].[ResNowOV_R1_Revenue_Class_4] TO [public]
GO
