...
SET ANSI_NULLS ON
GO
CREATE PROCEDURE [dbo].[outbound_view_brokerplan](
...
select @SQL = @SQL + N'and (charindex(lgh_outstatus, ''' + @lgh_oustatuslist + ''') > 0 AND l.lgh_carrier <> ''' + @newcarrier + ''') '
...
END
GO
GRANT EXECUTE ON  [dbo].[outbound_view_brokerplan] TO [public]
GO
