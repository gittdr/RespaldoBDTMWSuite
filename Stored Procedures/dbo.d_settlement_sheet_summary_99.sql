...
GO
/*  MODIFICATION LOG
01/08/09 MBR Created from d_settlement_sheet_summary_02n 

*/
/****** Object:  Stored Procedure dbo.d_settlement_sheet_summary_99   Script Date: 01/08/09 ******/
CREATE PROC [dbo].[d_settlement_sheet_summary_99](
...
SET mov_number = lh.mov_number,
    ...
    lgh_primary_pup = lh.lgh_primary_pup
...
GO
GRANT EXECUTE ON  [dbo].[d_settlement_sheet_summary_99] TO [public]
GO
