...
CREATE PROC [dbo].[d_loadaptrl_sp] @trL varchar(8) , @number int AS
/**
 * 
 * NAME:
 * dbo.d_loadaptrl_sp 
...
if @number = 1 
	...
	set rowcount 8
if exists ( SELECT trl_number FROM trailerprofile WHERE trl_number LIKE @trL + '%' 
		AND trl_actg_type = 'A' 
...
GO
GRANT EXECUTE ON  [dbo].[d_loadaptrl_sp] TO [public]
GO
