...
CREATE PROC [dbo].[d_masterbill81_sp] (@reprintflag varchar(10),@mbnumber int,@billto varchar(8), 
 ...
 * 
 * NAME:
 * dbo.d_masterbill81_sp
 *
 * TYPE:
 * StoredProcedure
 *
 * DESCRIPTION:
 * Return data for Masterbill 81
 *
 * RETURNS:
 * na
 *
 ...
 * 
 * REVISION HISTORY:
 * 4/18/2006.01 PRB - Created stored proc for use with Master Bill Format 81
 * 6/28/2006.02 PRB - Added fix for duedate, need to check if it ISNUMERIC.
 * 6/28/2006.03 PRB - Added fix for Route field, the client is using RTEID.
 *
 **/
...
GO
GRANT EXECUTE ON  [dbo].[d_masterbill81_sp] TO [public]
GO
