...
CREATE PROC [dbo].[deliverymanifest_rpt_02_sp] (@ord_number VARCHAR (12), @startdt DATETIME, @enddt DATETIME,
...
GO
GRANT EXECUTE ON  [dbo].[deliverymanifest_rpt_02_sp] TO [public]
GO
