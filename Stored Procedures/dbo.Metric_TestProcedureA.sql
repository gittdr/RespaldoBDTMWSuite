...
CREATE PROCEDURE [dbo].[Metric_TestProcedureA]
...
AS
	...
	*/
	...
	-- EXAMPLE PARAMETER INITIALIZATION. (COMMENTED OUT)
	...
	BEGIN
		...
		INSERT INTO @t (sort, textout) SELECT 2, '- ' + CONVERT(varchar(10), @DateStart, 101) + ' is a ' + DATENAME(dw, @DateStart) + '.'
	...
	SET NOCOUNT OFF
GO
GRANT EXECUTE ON  [dbo].[Metric_TestProcedureA] TO [public]
GO
