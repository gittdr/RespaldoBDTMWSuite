...
Create PROCEDURE [dbo].[tm_GET_AddressesbyDriverInboxOutbox]
 ...
 * 
 * NAME:
 * dbo.[tm_GET_AddressesbyDriverInboxOutbox]
 *
 * TYPE:
 * StoredProcedure 
 *
...
/* [tm_GET_AddressesbyDriverInboxOutbox]
 **************************************************************
*********************************************************************************/
SET NOCOUNT ON
...
GO
GRANT EXECUTE ON  [dbo].[tm_GET_AddressesbyDriverInboxOutbox] TO [public]
GO
