...
CREATE  Procedure [dbo].[SSRS_RB_CONFIRM_ICC_01]
		@lgh_number int
AS
...
select 
	...
	car.car_address1 as 'Carrier Address 1',
	car.car_address2 as 'Carrier Address2',
	carcty.cty_name + ', ' + carcty.cty_state + '  ' + isnull(car.car_zip,'') 'Carrier City',
...
from legheader l
	...
	left join city carcty on car.cty_code = carcty.cty_code
...
GO
GRANT EXECUTE ON  [dbo].[SSRS_RB_CONFIRM_ICC_01] TO [public]
GO
