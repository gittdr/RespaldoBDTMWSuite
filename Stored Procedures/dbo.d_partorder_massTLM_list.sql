...
SET ANSI_NULLS OFF
GO
Create proc [dbo].[d_partorder_massTLM_list] (@poh_identities varchar(255))
as
/**
 * 
 * NAME:
 * d_partorder_massTLM_list
 *
 * TYPE:
 * StoredProcedure
 *
 ...
 * REVISION HISTORY:
 * MRH 8/14/06 Created
 * MRH 6/22/10 Rewrote to match Mass TLM rewrite.
 *
 **/
...
select por_origin, por_destination, por_sequence, dw_sort from @results where por_origin is not null and por_destination is not null order by por_sequence

GO
GRANT EXECUTE ON  [dbo].[d_partorder_massTLM_list] TO [public]
GO
