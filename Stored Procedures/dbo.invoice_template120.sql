...
create procedure [dbo].[invoice_template120](@invoice_nbr int,@copies int)  
as  
/**
 * DESCRIPTION:
 *
 ...
 *
 * RETURNS:
 * RETURNS 0 - IF NO DATA WAS FOUND  
 * RESULT SETS: 
 *
 * REFERENCES:
 *
 * REVISION HISTORY:
	6/27/07 BPISK created copy form format 65 for PTS 37634 Texas Auto Carriers
	8/8/7 DPETE 38714  Correct SQL error invalid legth argument
...
--          print 'Minstp: ' + cast(@MinStp as varchar)
            ...
            --print 'Update: ' + cast(@MinStp as varchar) + ' ref: ' + isnull(@REF_STRING,'')
            --print '@MinIvdNumber: ' + cast(@MinIvdNumber as varchar) + ' cmd_code: ' + coalesce(@cmd_code,'')
...
GO
GRANT EXECUTE ON  [dbo].[invoice_template120] TO [public]
GO
