...
create procedure [dbo].[invoice_template146](@invoice_nbr  	int,@copies		int)
as
...
from 	#invtemp_tbl,
		city RIGHT OUTER JOIN stops ON city.cty_code = stops.stp_city  --pts40188 outer join conversion
...
GO
GRANT EXECUTE ON  [dbo].[invoice_template146] TO [public]
GO
