...
create PROC [dbo].[d_scroll_payheaders_sp]    (
               @Types varchar(60),
               @Status varchar(60),
               @LoPayDate datetime,
               @HiPayDate datetime,
               ...
               @tpr_id char(8),     -- 30
               @tpr_type char(12),
               @MissingArgResourcetypeonleg  char(1),
...
-- *************
If @view_id <> ''
   exec d_scroll_payheaders_forviews_sp @hold_hld, @released_pnd, @collected_col, @closed_rel, @LoPayDate , @HiPayDate, @view_id
Else
Begin
...
GO
GRANT EXECUTE ON  [dbo].[d_scroll_payheaders_sp] TO [public]
GO
