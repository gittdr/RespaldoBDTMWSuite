...
SET ANSI_NULLS ON
GO
create proc [dbo].[InvServiceGetOrderStatusAlert] @cmp_revtype1 varchar(6),
...
select cmp_id, forecast_bucket, cmd_code, SafeFill, [ShutDown], PriorReadingDate, PriorReading, 
  ...
  NowReading, RunOutDate, Questionable, Status
  from #readings
  where Status <> 'OK'
order by runoutdate
...
GO
GRANT EXECUTE ON  [dbo].[InvServiceGetOrderStatusAlert] TO [public]
GO
