...
CREATE PROCEDURE [dbo].[DuplicateCompanyAddress_Excel]  (@p_company_name varchar(100),
 @p_company_address1 varchar(100),
 @p_company_address2 varchar(100),
 @p_cty_nmstct varchar(100),
 @p_company_zip varchar(100))					
AS 
 
/**
 * 
 * NAME:
 * dbo.DuplicateCompanyAddress_Excel
 *
 * TYPE:
 * StoredProcedure
 *
 ...
 * 003 - @p_company_address2, , varchar(100),input, null;
 * 004 - @p_cty_nmstct, varchar(100), input, null; 
 * 005 - @p_company_zip, , varchar(100),input, null;   
 *
...
select @p_company_address = isnull(@p_company_address1,'')+'+'+ 
			    isnull(@p_company_address2,'')+'+'+ 
                            isnull(@p_cty_nmstct,'')+'+'+ 
                            isnull(@p_company_zip,'')
...
END
GO
GRANT EXECUTE ON  [dbo].[DuplicateCompanyAddress_Excel] TO [public]
GO
