...
CREATE Proc [dbo].[WatchDog_KatoenOrdStatus] 
(
...
where stops.ord_hdrnumber in (select ord_hdrnumber from orderheader where ord_billto = @billto  and ord_status  not in ('CAN','MST','PND'))
