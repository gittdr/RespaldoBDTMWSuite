...
create PROC [dbo].[d_refstops_commaseplist_sp] (@p_table varchar(30),@p_ordhdrnumber int,@p_withtypesflag varchar(10))
AS  
/**
 * 
 * NAME:
 * dbo.d_refstops_commaseplist_sp
 *
 * TYPE:
 * [StoredProcedure)
 *
 ...
 * 
 * REVISION HISTORY:
 * 03/13/2006.01 ? PTS33638 - Phil Bidinger ? Created for Jack B Kelley Invoice format 97
 *
 **/
...
Select Distinct ref_type, ref_number,ref_tablekey, ref_sequence 
From referencenumber    
Where ref_table = @p_table and     
ord_hdrnumber = @p_ordhdrnumber  
...
GO
GRANT EXECUTE ON  [dbo].[d_refstops_commaseplist_sp] TO [public]
GO
