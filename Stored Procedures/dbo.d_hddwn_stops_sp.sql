...
/****** Object:  Stored Procedure dbo.d_hddwn_stops_sp    Script Date: 6/1/99 11:54:46 AM ******/
/****** Object:  Stored Procedure dbo.d_hddwn_stops_sp    Script Date: 8/20/97 1:57:32 PM ******/
create proc [dbo].[d_hddwn_stops_sp] (	@stringparm varchar(13),
				@numberparm int,
...
SELECT  stops.stp_event, 
	...
	stops.stp_arrivaldate 'arr_tm',
	stops.stp_departuredate 'dep_dte',
	stops.stp_departuredate 'dep_tm',
	@slacktime slacktime
FROM stops, city, event, orderheader, labelfile lbl1, labelfile lbl2
WHERE   ( stops.stp_city = city.cty_code ) AND 
	...
	(( stops.stp_reasonlate_depart *= lbl2.abbr ) AND ( lbl2.labeldefinition = "ReasonLate" ))
ORDER BY stops.stp_mfh_sequence, stops.ord_hdrnumber, stops.stp_sequence


GO
GRANT EXECUTE ON  [dbo].[d_hddwn_stops_sp] TO [public]
GO
