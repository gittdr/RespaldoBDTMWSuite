...
create proc [dbo].[d_load_supplier_compid_sp] 
	@comp 		varchar(8) 
	,@number	int 
as
 ...
 *
 * REVISION HISTORY:
 * 8/8/2006.01 ? PTS33397 - Dan Hudec ? Created Procedure
 *
 **/
...
set rowcount 0 
GO
GRANT EXECUTE ON  [dbo].[d_load_supplier_compid_sp] TO [public]
GO
