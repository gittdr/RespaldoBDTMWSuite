...
CREATE proc [dbo].[sp_caratqualaunitra] 
 @fechaini datetime,
 @fechafin datetime
...
from stops
where stops.ord_hdrnumber in (select ord_hdrnumber from invoiceheader where ivh_billto = 'QUALAMEX' and ivh_invoicestatus in ('PRN','XFR'))
