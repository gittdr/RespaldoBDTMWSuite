...
CREATE PROC [dbo].[d_masterbill101_sp](  
 ...
 *   
 * REVISION HISTORY:  
 * 07/25/07.01 PTS38049 - OS - Created stored proc based on format 75 
 *    changed ref_number field to order header BOL or PO ref list .
 *    removed subtiotal for fuel surcharge added to 75 after this SR written up. 
 *  40289 BDH added fgt_number
 **/  
...
GO
GRANT EXECUTE ON  [dbo].[d_masterbill101_sp] TO [public]
GO
