...
CREATE PROCEDURE [dbo].[invoice_template110_refsubreport] (@ord_hdrnumber int, @ivh_hdrnumber int)
AS
/*
*
* 
* NAME:invoice_template110_refsubreport
* dbo.invoice_template110_refsubreport
*
* TYPE:
* StoredProcedure
*
...
GO
GRANT EXECUTE ON  [dbo].[invoice_template110_refsubreport] TO [public]
GO
