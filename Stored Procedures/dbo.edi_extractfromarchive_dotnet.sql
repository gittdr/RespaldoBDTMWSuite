 ...
 * 09/21/2009 PTS 49169 - D.Wilks add company id for re-extract to trp_id specific locations    
 * 3/10/2016  PTS 62055 - D. Wilks change query to support new index on edt_selected
 **/    
...
BEGIN    
 ...
 UPDATE edi_document_tracking set edt_selected = 'N' where edt_selected = 'Y' or edt_selected is null
END    
...
GO
GRANT EXECUTE ON  [dbo].[edi_extractfromarchive_dotnet] TO [public]
GO
