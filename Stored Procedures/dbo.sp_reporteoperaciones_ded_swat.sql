...
CREATE procedure [dbo].[sp_reporteoperaciones_ded_swat]
AS
...
Execute sp_TTSTMWAllocateRevVsPay_SSRS1_DED_Swat 'D',@ls_fechasabini,@ls_fechaviefin,'','','',' ','N','Y','N','CMP',' ',' ',' ',' ',' ',' ','P&G',' ',' ',' ',' ','DM','N','Y',' ',' '
