...
SET ANSI_NULLS ON
GO
Create procedure [dbo].[estatGetIPTOrdFromTrlr_sp] 	@trl_number char(13)
-- Given a trailer number: return the ordernumbers of all orders 
-- to which that trailer is assigned, if the orders have status of PENDING. 
-- Return zero if no such order found.
-- Example: exec estatGetIPTOrdFromTrlr_sp '3001'
-- 11/1/06: mov_number is not needed
as 
SET NOCOUNT ON
...
End
GO
GRANT EXECUTE ON  [dbo].[estatGetIPTOrdFromTrlr_sp] TO [public]
GO
