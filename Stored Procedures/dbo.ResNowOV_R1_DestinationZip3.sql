...
CREATE PROCEDURE [dbo].[ResNowOV_R1_DestinationZip3]
...
*/
	...
	BEGIN
		IF IsNull(@ItemID, '') > ''
		BEGIN	SELECT 
				dbo.fnc_zip3(c1.cmp_zip, c1.cmp_state, c1.cmp_city, @StateOnly) AS [Zip3Destination],
...
GO
GRANT EXECUTE ON  [dbo].[ResNowOV_R1_DestinationZip3] TO [public]
GO
