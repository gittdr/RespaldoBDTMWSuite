...
CREATE PROCEDURE [dbo].[tmail_MakeCheckcallFromQcEssEvent2]	
		@ckc_status       		CHAR(6),		-- 
		@ckc_asgntype     		CHAR(6),		-- 
...
-- =============================================================================
-- Stored Proc: tmail_MakeCheckcallFromQcEssEvent2
...
SELECT @ckc_number AS 'checkcall_nbr', @ckc_asgnid AS 'checkcall_vehicle', @ckc_date AS 'checkcall_date'

GO
GRANT EXECUTE ON  [dbo].[tmail_MakeCheckcallFromQcEssEvent2] TO [public]
GO
