...
CREATE PROCEDURE [dbo].[tmail_routesync_getBlobRecords_Omnitracs]
AS
-- =============================================================================
--	Stored Proc: [dbo].[tmail_routesync_getBlobRecords_Omnitracs]
--	Author     :	Rob Scott
--	Create date: 2013.10.31  - PTS 71605
--	Description:
--
...
---------------------------------------------------------------------------------
	SELECT * FROM @tbl
GO
GRANT EXECUTE ON  [dbo].[tmail_routesync_getBlobRecords_Omnitracs] TO [public]
GO
