...
CREATE PROC [dbo].[d_settlement_sheet_summary_52](
...
-- PTS 29515 -- BL (end)
-- PTS 31045 JJF 2/10/06
	trl_number		varchar(8) null)
-- END PTS 31045 JJF 2/10/06
...
-- PTS 31045 JJF 2/10/06
UPDATE #temp_pd
   SET trl_number = (SELECT lgh_primary_trailer
                      FROM legheader lh 
                     WHERE lh.lgh_number = #temp_pd.lgh_number)
-- END PTS 31045 JJF 2/10/06
...
GO
GRANT EXECUTE ON  [dbo].[d_settlement_sheet_summary_52] TO [public]
GO
