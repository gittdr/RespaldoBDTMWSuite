...
GO
 ...
 create proc [dbo].[ini_report_audit_section_sp]
(
    @file_id int,
    @section_id int,
    @item_id int,
...
/************************************************************************************
 NAME:		ini_report_audit_section_sp
 DOS NAME:	tmwsp_ini_report_audit_section_sp.sql
 TYPE:		stored procedure
 DATABASE:	TMW
 PURPOSE:   Audit Report information for the ini_user_maintenance app
 DEPENDANCIES:
 PROCESS:
 exec ini_report_audit_section_sp 33, 665, 0, 'LLEHMANN', 'Jan 12 2000', 'Jan 16 2002', 'user'
 ---------------------------------------------------------------------------
REVISION LOG
...
from ini_audit a
     inner join ini_section b 
        on a.audit_section =b.section_name
where 
...
GO
GRANT EXECUTE ON  [dbo].[ini_report_audit_section_sp] TO [public]
GO
