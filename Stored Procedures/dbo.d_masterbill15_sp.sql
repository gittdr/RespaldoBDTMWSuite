...
CREATE PROC [dbo].[d_masterbill15_sp] (@reprintflag varchar(10),@mbnumber int,@billto varchar(8), 
...
-- dpete for LOR pts4785 provide for maitlto override of billto
    ...
    FROM invoiceheader LEFT OUTER JOIN referencenumber ref1 ON (ref1.ref_tablekey = invoiceheader.ord_hdrnumber and ref1.ref_table = 'orderheader' and ref1.ref_type ='BL#')
				LEFT OUTER JOIN referencenumber ref2 ON (ref2.ref_tablekey = invoiceheader.ord_hdrnumber and ref2.ref_table = 'orderheader' and ref2.ref_type ='SER'), 
		company cmp1, city cty1, city cty2
...
GO
GRANT EXECUTE ON  [dbo].[d_masterbill15_sp] TO [public]
GO
