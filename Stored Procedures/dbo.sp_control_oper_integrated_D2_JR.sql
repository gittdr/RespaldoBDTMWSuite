...
CREATE PROCEDURE [dbo].[sp_control_oper_integrated_D2_JR]   @lider varchar(12)
AS
DECLARE	
	@V_fechadom		DateTime, 
	@V_fechasab		DateTime,
...
DECLARE @TTOperadores_Control_D2 TABLE(
...
INSERT Into @TTOperadoresporflota
		...
		If Exists ( Select count(*) From  @TTOperadoresporflota )
				...
				-- Llena los totales de cada codigo.
					--Domingo Dia 1 Descansos
						Insert Into @TTOperadores_Control_D2 (codigo,OpeId,OpeNombre, Fechaini, Fechafin, FolioExp )
	...
	--					Insert Into @TTOperadores_Control_D2 (codigo,OpeId,OpeNombre, Fechaini, Fechafin )
...
select * from @TTOperadores_Control_D2
