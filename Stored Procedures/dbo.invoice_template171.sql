...
create procedure [dbo].[invoice_template171](@invoice_nbr   int,@copies  int)  
as  
...
5/24/10 TMEZE PTS 52066 Copied SP invoice_template2_50 and created invoice_template171.
3/25/11 TMEZE PTS 53865 Increased Temp address space to 100 characters.
*/  
...
GO
GRANT EXECUTE ON  [dbo].[invoice_template171] TO [public]
GO
