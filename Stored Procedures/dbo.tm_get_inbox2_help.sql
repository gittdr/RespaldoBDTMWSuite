...
CREATE PROCEDURE [dbo].[tm_get_inbox2_help]	@LoginSN INT,
					@LoginInboxSN INT,
					@MaxMessages INT
AS
...
SET NOCOUNT ON
	...
	SELECT @AddressBy = CONVERT(int, Text) FROM tblRs WHERE KeyCode = 'ADDRESSBY'	
	...
	SET ROWCOUNT 0
GO
GRANT EXECUTE ON  [dbo].[tm_get_inbox2_help] TO [public]
GO
