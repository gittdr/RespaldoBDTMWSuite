...
create procedure [dbo].[invoice_template2_greatrigs](@invoice_nbr  	int,@copies		int)
as
...
/* CREATE TEMP TABLE AND SELECT INITIAL DATA SET 
 ...
 SELECT  invoiceheader.ivh_invoicenumber,   
	...
	-- PTS #11431 - replace @char20 with the invoicedetail refnum value
        ivd_refnum vin_number,
...
/*	PTS #11431 - Commented out SQL to update the VIN number.  Did not work.  Using the 'FRGTREFTOINV' and
	'INVREFNUM' Generalinfo settings to get the VIN from the Freightdetail to the Invoicedetail record
	instead.
update #invtemp_tbl
set    vin_number = freightdetail.fgt_refnum
from   #invtemp_tbl,freightdetail
where 	 freightdetail.stp_number = #invtemp_tbl.stp_number and freightdetail.cmd_code = #invtemp_tbl.cmd_code --and
        -- referencenumber.ref_tablekey = freightdetail.fgt_number and
        -- ref_type = 'VIN' and ref_table = 'freightdetail'	*/
...
GO
GRANT EXECUTE ON  [dbo].[invoice_template2_greatrigs] TO [public]
GO
