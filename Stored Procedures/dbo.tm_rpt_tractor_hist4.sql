...
CREATE PROCEDURE [dbo].[tm_rpt_tractor_hist4] @StartDate datetime,
					 @EndDate datetime,
					 @Truck varchar (15),
					 @sUseKM varchar(1)
...
SELECT  TruckName,
	CONVERT(VARCHAR(26), DateAndTime) DateAndTime,
	Miles,	
	Direction,	
	VehicleIgnition,
	CityName,
...
ORDER BY DateAndTime
GO
GRANT EXECUTE ON  [dbo].[tm_rpt_tractor_hist4] TO [public]
GO
