...
SET ANSI_NULLS ON
GO
CREATE PROCEDURE [dbo].[tmail_rpt_drv_unitsnear]
...
SELECT  ckc_driver as ckc_tractor,		-- VB code depends on this being called ckc_tractor
...
ORDER by ckc_driver
GO
GRANT EXECUTE ON  [dbo].[tmail_rpt_drv_unitsnear] TO [public]
GO
