...
CREATE PROC [dbo].[d_loadtrl_with_inactive_sp] @trl varchar(13) , @number int AS
/**
 * 
 * NAME:
 * dbo.d_loadtrl_with_inactive_sp 
 *
 * TYPE:
 * Stored Procedure
 *
...
GO
GRANT EXECUTE ON  [dbo].[d_loadtrl_with_inactive_sp] TO [public]
GO
