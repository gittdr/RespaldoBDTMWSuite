...
create procedure [dbo].[invoice_template4](@invoice_nbr  	int,@copies		int)
as
...
* PTS53444 total is rounded on format DPETE
*/
...
/* CREATE TEMP TABLE AND SELECT INITIAL DATA SET 
 ...
 SELECT  invoiceheader.ivh_invoicenumber,   
	 ...
	 @temp_nmstct dest_nmctst,
         ...
         convert(decimal(9,2),invoicedetail.ivd_charge) ivd_charge, 
...
GO
GRANT EXECUTE ON  [dbo].[invoice_template4] TO [public]
GO
