...
CREATE PROC [dbo].[d_settlement_sheet_summary_41](
...
CREATE TABLE #temp_pd(
	...
	resource_altid		varchar(8) null,
	payto_altid		varchar(8) null,
	pyt_basis       varchar(6) null ,		-- PTS 49758
	pyt_basisunit   varchar(6) null,		-- PTS 49758  
	trk_primary     char(1) null, 			-- PTS 49758 
	tar_tarriffnumber varchar(12) null )	-- PTS 49758
...
SELECT pd.pyd_number,
	...
	null,
	null,
	null,		--     pyt_basis		-- PTS49758
	null,		-- pyt_basisunit  		-- PTS49758
	null,		-- trk_primary    		-- PTS49758
	tar_tarriffnumber					-- PTS49758 	
...
-- JJF PTS 25879
UPDATE #temp_pd
SET	resource_altid		= car_otherid
from 	carrier
WHERE 	#temp_pd.asgn_type = 'CAR' and
	#temp_pd.asgn_id = carrier.car_id
-- END PTS 25879
...
-------  PTS 49758 <<start>>
		--pyt_basis       varchar(6) null ,		---  New request  
		--	pyt_basisunit   varchar(6) null,	---  New request  
		--	trk_primary     char(1) null )		---  New request  	
			
UPDATE #temp_pd
set #temp_pd.pyt_basis = paytype.pyt_basis,
#temp_pd.pyt_basisunit = paytype.pyt_basisunit
from paytype where #temp_pd.pyt_itemcode = paytype.pyt_itemcode

UPDATE #temp_pd
set #temp_pd.trk_primary = tariffkey.trk_primary 
from tariffkey where #temp_pd.tar_tarriffnumber   = tariffkey.tar_number
------  PTS 49758  <<end>>
...
SELECT pyd_number, 
	...
	payto_altid,
	pyt_basis,				-- PTS 49758
	pyt_basisunit,			-- PTS 49758 
	trk_primary,			-- PTS 49758   
	tar_tarriffnumber 		-- PTS 49758
  FROM #temp_pd tp LEFT OUTER JOIN payheader ph ON tp.pyh_number = ph.pyh_pyhnumber

GO
GRANT EXECUTE ON  [dbo].[d_settlement_sheet_summary_41] TO [public]
GO
