...
CREATE Proc [dbo].[WatchDog_DuplicateOrderTrl] 
(
...
group by ord_billto, cmpbillto.cmp_name, ord_shipper, cmpshipper.cmp_name,
       ord_consignee, cmpconsignee.cmp_name, ord_startdate, ord_trailer
...
GO
GRANT EXECUTE ON  [dbo].[WatchDog_DuplicateOrderTrl] TO [public]
GO
