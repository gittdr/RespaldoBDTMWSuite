...
CREATE PROC [dbo].[d_settlement_sheet_summary23] (
...
CREATE TABLE #temp_pd(
	...
	mpp_senioritydate	datetime null,
	lgh_driver1 varchar(13) null,
	lgh_driver1name varchar(255) null,
...
Update #temp_pd
SET		 lgh_driver1 = a.lgh_driver1,
			 lgh_driver1name  = b.mpp_lastname + ',' + b.mpp_firstname
FROM   legheader a , manpowerprofile b
Where  #temp_pd.lgh_number = a.lgh_number and 
			 a.lgh_driver1 = b.mpp_id
...
GO
GRANT EXECUTE ON  [dbo].[d_settlement_sheet_summary23] TO [public]
GO
