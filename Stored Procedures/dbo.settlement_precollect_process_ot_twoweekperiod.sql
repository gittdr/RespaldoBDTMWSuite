...
create procedure [dbo].[settlement_precollect_process_ot_twoweekperiod](	@pl_pyhnumber int , @ps_asgn_type varchar(6),@ps_asgn_id varchar(13) ,
														@pdt_payperiod datetime, @psd_id int , @ps_message varchar(255) OUT)
as
/**
 * 
 * NAME:
 * dbo.settlement_precollect_process_ot_twoweekperiod
 *
 * TYPE:
 * StoredProcedure
 *
...
return @li_ret 
GO
GRANT EXECUTE ON  [dbo].[settlement_precollect_process_ot_twoweekperiod] TO [public]
GO
