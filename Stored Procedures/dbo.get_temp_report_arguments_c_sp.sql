...
CREATE PROC [dbo].[get_temp_report_arguments_c_sp]
      ( @temp_report_name           VARCHAR(200)
      , @temp_report_argument_name  VARCHAR(200)
      , @temp_report_argument_value VARCHAR(200)   OUTPUT
...
*
* NAME:
* dbo.get_temp_report_arguments_c_sp
*
* TYPE:
* StoredProcedure
*
...
BEGIN
   ...
   DECLARE @temp_report_argument_value_char NVARCHAR(200)
   SELECT @debug_ind = 'N'
   ...
   Else
      SELECT @temp_report_argument_value = @temp_report_argument_value_char

   If @debug_ind = 'Y'
      Print @temp_report_argument_name + ' - ' + @temp_report_argument_value

   RETURN
   
END
GO
GRANT EXECUTE ON  [dbo].[get_temp_report_arguments_c_sp] TO [public]
GO
