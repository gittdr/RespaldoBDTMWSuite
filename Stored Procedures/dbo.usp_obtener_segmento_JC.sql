...
begin
        Select TOP 1 h.lgh_number as Segmento ,v.Folio as Folio, v.Fecha as Fechatimbrado, o.ord_billto as cliente, h.ord_hdrnumber as orden, v.cancelfactura cancelada , v.pdf_descargafactura PDF
