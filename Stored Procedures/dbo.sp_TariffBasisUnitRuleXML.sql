...
CREATE PROC [dbo].[sp_TariffBasisUnitRuleXML]
...
BEGIN
    ...
    IF @TarModule = 'B'
    BEGIN
        EXEC sp_ChargeTypeBasisUnitRuleXML @TarNumber = @TarNumber
    ...
    IF @TarModule = 'S'
    BEGIN
        EXEC sp_PayTypeBasisUnitRuleXML @TarNumber = @TarNumber
                                      , @CallerAppABBR = @CallerAppABBR
                                      , @TariffInputXml = @TariffInputXml
                                      , @Quantity = @Quantity OUTPUT
                                      , @Rate = @Rate OUTPUT
...
END
GO
GRANT EXECUTE ON  [dbo].[sp_TariffBasisUnitRuleXML] TO [public]
GO
