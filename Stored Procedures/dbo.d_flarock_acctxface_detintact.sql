...
CREATE PROC [dbo].[d_flarock_acctxface_detintact]
...
SELECT * from #invdet_interact order by ivh_hdrnumber, ivh_invoicenumber

GO
GRANT EXECUTE ON  [dbo].[d_flarock_acctxface_detintact] TO [public]
GO
