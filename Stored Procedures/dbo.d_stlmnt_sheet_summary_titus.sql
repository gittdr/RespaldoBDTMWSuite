...
DPETE PTS 16754 Fix ytd number using fixes made to settlment sheet 15 as a model

*/
/****** Object:  Stored Procedure dbo.d_stlmnt_sheet_summary_titus    Script Date: 6/24/98 10:17:22 AM ******/
CREATE PROC [dbo].[d_stlmnt_sheet_summary_titus](
 ...
 * 
 * NAME:
 * dbo.d_stlmnt_sheet_summary_titus
 *
 * TYPE:
 * Stored Procedure
 *
...
/*
--BEGIN PTS 57434 PCURR 6/14/11 This is overstating the YTD for current period
UPDATE #YTDBAL
...
GO
GRANT EXECUTE ON  [dbo].[d_stlmnt_sheet_summary_titus] TO [public]
GO
