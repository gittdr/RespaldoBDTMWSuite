...
CREATE  PROCEDURE [dbo].[invoice_template91](@p_invoice_nbr	int, @p_copies  int)  			
AS
/**
 * 
 * NAME:
 * dbo.invoice_template91
 *
 * TYPE:
 * StoredProcedure
 *
...
--18-MAY-2006 SWJ - Changed to join on invoicedetail, not invoiceheader
...
GO
GRANT EXECUTE ON  [dbo].[invoice_template91] TO [public]
GO
