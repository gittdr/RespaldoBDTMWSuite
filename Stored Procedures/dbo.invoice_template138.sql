...
CREATE procedure [dbo].[invoice_template138](@p_invoice_nbr int,@p_copies  int)  
as
 ...
 * 01/25/08 BDH  Created this proc from invoicetemplate64 for pts 40075.
 **/
...
return @v_ret_value
GO
GRANT EXECUTE ON  [dbo].[invoice_template138] TO [public]
GO
