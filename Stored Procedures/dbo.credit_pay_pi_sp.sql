...
CREATE PROC [dbo].[credit_pay_pi_sp](@ivh_hdrnumber int, @user_id varchar(20), @ivh_credit_hdrnumber int)
AS

/*
*	PTS 43873 - DJM - added the pyd_min_period field to the copied values.
*/
...
GO
GRANT EXECUTE ON  [dbo].[credit_pay_pi_sp] TO [public]
GO
