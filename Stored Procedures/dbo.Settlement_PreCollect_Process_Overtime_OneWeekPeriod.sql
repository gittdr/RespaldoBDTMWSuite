...
GO
/*-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| BEGIN CREATE procedure for 'Settlement_PreCollect_Process_Overtime_OneWeekPeriod' for .NET Overtime Pay calculations                                        	                 |
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
CREATE PROCEDURE [dbo].[Settlement_PreCollect_Process_Overtime_OneWeekPeriod](@pl_pyhnumber INT, @ps_asgn_type VARCHAR(6), @ps_asgn_id VARCHAR(13), @pdt_payperiod DATETIME, @psd_id INT)
AS
...
GO
GRANT EXECUTE ON  [dbo].[Settlement_PreCollect_Process_Overtime_OneWeekPeriod] TO [public]
GO
