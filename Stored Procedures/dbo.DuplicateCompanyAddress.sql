...
CREATE PROCEDURE [dbo].[DuplicateCompanyAddress]  (@p_company_name varchar(100), @p_company_address varchar(255))					
AS
/**
 * 
 * NAME:
 * dbo.DuplicateCompanyAddress
 *
 * TYPE:
 * StoredProcedure
 *
...
END
GO
GRANT EXECUTE ON  [dbo].[DuplicateCompanyAddress] TO [public]
GO
