...
create  PROCEDURE       [dbo].[inbound_view_drv]
...
-- company_cmp_name varchar(100),
   ...
   mpp_prior_ctyname varchar(25) null,
   ...
   -- END PTS 60224 SPN
	,udf_drv_1				varchar(255)	null,
	udf_drv_2				varchar(255)	null,
	udf_drv_3				varchar(255)	null,
	udf_drv_4				varchar(255)	null,
	udf_drv_5				varchar(255)	null,
	udf_drv_6				varchar(255)	null,
	udf_drv_7				varchar(255)	null,
	udf_drv_8				varchar(255)	null,
	udf_drv_9				varchar(255)	null,
	udf_drv_10				varchar(255)	null,
	udf_drv_1_t				varchar(255)	null,
	udf_drv_2_t				varchar(255)	null,
	udf_drv_3_t				varchar(255)	null,
	udf_drv_4_t				varchar(255)	null,
	udf_drv_5_t				varchar(255)	null,
	udf_drv_6_t				varchar(255)	null,
	udf_drv_7_t				varchar(255)	null,
	udf_drv_8_t				varchar(255)	null,
	udf_drv_9_t				varchar(255)	null,
	udf_drv_10_t			varchar(255)	null, 
	mpp_lastlog_estdate	datetime null, 
	mpp_dailyhrsest	decimal (5,2) null,
	mpp_weeklyhrsest decimal (5,2) null
)
...
--         then isnull(manpowerprofile.mpp_hours1,-100)
         then COALESCE(manpowerprofile.mpp_fourteenhrest, manpowerprofile.mpp_hours1, -100)
-- END PTS 61038 SPN
         else -100
         end loghrs,
      --vmj1-
   ...
   /* 03/27/2012 MDH PTS 59481: <<END>> */
   -- BEGIN PTS 60224 SPN
   , manpowerprofile.mpp_fourteenhrest
   -- END PTS 60224 SPN
...
/* 03/29/2013 MDH PTS 66801: <<START>> */
IF EXISTS (SELECT * FROM generalinfo WHERE gi_name = 'UDF_DRV_1' and substring(gi_string1,1,1) = 'Y' ) BEGIN
	SELECT	@udflabel = dbo.UDF_DRV_1_fn('', 'L')
	UPDATE	#tt
	SET		UDF_DRV_1 = dbo.UDF_DRV_1_fn(#tt.mpp_id, 'D'),	UDF_DRV_1_t = @udflabel
END
IF EXISTS (SELECT * FROM generalinfo WHERE gi_name = 'UDF_DRV_2' and substring(gi_string1,1,1) = 'Y' ) BEGIN
	SELECT	@udflabel = dbo.UDF_DRV_2_fn('', 'L')
	UPDATE	#tt
	SET		UDF_DRV_2 = dbo.UDF_DRV_2_fn(#tt.mpp_id, 'D'),	UDF_DRV_2_t = @udflabel
END
IF EXISTS (SELECT * FROM generalinfo WHERE gi_name = 'UDF_DRV_3' and substring(gi_string1,1,1) = 'Y' ) BEGIN
	SELECT	@udflabel = dbo.UDF_DRV_3_fn('', 'L')
	UPDATE	#tt
	SET		UDF_DRV_3 = dbo.UDF_DRV_3_fn(#tt.mpp_id, 'D'),	UDF_DRV_3_t = @udflabel
END
IF EXISTS (SELECT * FROM generalinfo WHERE gi_name = 'UDF_DRV_4' and substring(gi_string1,1,1) = 'Y' ) BEGIN
	SELECT	@udflabel = dbo.UDF_DRV_4_fn('', 'L')
	UPDATE	#tt
	SET		UDF_DRV_4 = dbo.UDF_DRV_4_fn(#tt.mpp_id, 'D'),	UDF_DRV_4_t = @udflabel
END
IF EXISTS (SELECT * FROM generalinfo WHERE gi_name = 'UDF_DRV_5' and substring(gi_string1,1,1) = 'Y' ) BEGIN
	SELECT	@udflabel = dbo.UDF_DRV_5_fn('', 'L')
	UPDATE	#tt
	SET		UDF_DRV_5 = dbo.UDF_DRV_5_fn(#tt.mpp_id, 'D'),	UDF_DRV_5_t = @udflabel
END
IF EXISTS (SELECT * FROM generalinfo WHERE gi_name = 'UDF_DRV_6' and substring(gi_string1,1,1) = 'Y' ) BEGIN
	SELECT	@udflabel = dbo.UDF_DRV_6_fn('', 'L')
	UPDATE	#tt
	SET		UDF_DRV_6 = dbo.UDF_DRV_6_fn(#tt.mpp_id, 'D'),	UDF_DRV_6_t = @udflabel
END
IF EXISTS (SELECT * FROM generalinfo WHERE gi_name = 'UDF_DRV_7' and substring(gi_string1,1,1) = 'Y' ) BEGIN
	SELECT	@udflabel = dbo.UDF_DRV_7_fn('', 'L')
	UPDATE	#tt
	SET		UDF_DRV_7 = dbo.UDF_DRV_7_fn(#tt.mpp_id, 'D'),	UDF_DRV_7_t = @udflabel
END
IF EXISTS (SELECT * FROM generalinfo WHERE gi_name = 'UDF_DRV_8' and substring(gi_string1,1,1) = 'Y' ) BEGIN
	SELECT	@udflabel = dbo.UDF_DRV_8_fn('', 'L')
	UPDATE	#tt
	SET		UDF_DRV_8 = dbo.UDF_DRV_8_fn(#tt.mpp_id, 'D'),	UDF_DRV_8_t = @udflabel
END
IF EXISTS (SELECT * FROM generalinfo WHERE gi_name = 'UDF_DRV_9' and substring(gi_string1,1,1) = 'Y' ) BEGIN
	SELECT	@udflabel = dbo.UDF_DRV_9_fn('', 'L')
	UPDATE	#tt
	SET		UDF_DRV_9 = dbo.UDF_DRV_9_fn(#tt.mpp_id, 'D'),	UDF_DRV_9_t = @udflabel
END
IF EXISTS (SELECT * FROM generalinfo WHERE gi_name = 'UDF_DRV_10' and substring(gi_string1,1,1) = 'Y' ) BEGIN
	SELECT	@udflabel = dbo.UDF_DRV_10_fn('', 'L')
	UPDATE	#tt
	SET		UDF_DRV_10 = dbo.UDF_DRV_10_fn(#tt.mpp_id, 'D'),	UDF_DRV_10_t = @udflabel
END
/* 03/29/2013 MDH PTS 66801: <<END>> */

SELECT  mpp_id,                                                                                                        -- 001
   company_cmp_id,                                                                                                     -- 002
   company_cmp_name,                                                                                                   -- 003
   city_cty_nmstct,                                                                                                    -- 004
   mpp_teamleader,                                                                                                     -- 005
   mpp_avl_date,                                                                                                       -- 006
   mpp_status,                                                                                                         -- 007
   ...
   loghrs,                                                                                                             -- 025
   filtflag,                                                                                                           -- 026
   mpptype1labelname = (SELECT MAX ( userlabelname ) FROM labelfile WHERE labeldefinition = 'DrvType1'),               -- 027
   mpptype2labelname = (SELECT MAX ( userlabelname ) FROM labelfile WHERE labeldefinition = 'DrvType2'),               -- 028
   mpptype3labelname = (SELECT MAX ( userlabelname ) FROM labelfile WHERE labeldefinition = 'DrvType3'),               -- 029
   mpptype4labelname = (SELECT MAX ( userlabelname ) FROM labelfile WHERE labeldefinition = 'DrvType4'),               -- 030
   servicerule,                                                                                                        -- 031
   loghrs,                                                                                                             -- 032
   mpp_hiredate,                                                                                                       -- 033
   mpp_lastfirst,                                                                                                      -- 034
   mpp_gps_desc,                                                                                                       -- 035
   mpp_gps_date,                                                                                                       -- 036
        mpp_travel_minutes,                                                                                            -- 037
        mpp_mile_day7,                                                                                                 -- 038
        mpp_last_log_date,                                                                                             -- 039
   mpp_hours1,                                                                                                         -- 040
   mpp_hours2,                                                                                                         -- 041
   mpp_hours3,                                                                                                         -- 042
   mpp_last_home_date,                                                                                                 -- 043
   mpp_prior_event,                                                                                                    -- 044
   mpp_prior_cmp_id,                                                                                                   -- 045
   mpp_prior_city,                                                                                                     -- 046
   mpp_prior_ctyname,                                                                                                  -- 047
   mpp_prior_state,                                                                                                    -- 048
   mpp_prior_region1,                                                                                                  -- 049
   mpp_prior_region2,                                                                                                  -- 050
   mpp_prior_region3,                                                                                                  -- 051
   mpp_prior_region4,                                                                                                  -- 052
   mpp_prior_cmp_name,                                                                                                 -- 053
   mpp_next_event,                                                                                                     -- 054
   mpp_next_cmp_id,                                                                                                    -- 055
   mpp_next_city,                                                                                                      -- 056
   mpp_next_ctyname,                                                                                                   -- 057
   mpp_next_state,                                                                                                     -- 058
   mpp_next_region1,                                                                                                   -- 059
   mpp_next_region2,                                                                                                   -- 060
   mpp_next_region3,                                                                                                   -- 061
   mpp_next_region4,                                                                                                   -- 062
   mpp_next_cmp_name,                                                                                                  -- 063
   cmp_geoloc,                                                                                                         -- 064
   mpp_next_exp_code,                                                                                                  -- 065
   mpp_next_exp_name,                                                                                                  -- 066
   mpp_next_exp_date,                                                                                                  -- 067
   mpp_next_exp_compldate,                                                                                             -- 068
   CASE
      WHEN mpp_bid_next_starttime IS NULL THEN ''
      ELSE
         CASE mpp_bid_next_type
            WHEN 'ONCALL' THEN RIGHT('0' + CONVERT(VARCHAR(2), DATEPART(mm, mpp_bid_next_starttime)), 2) + '/' + RIGHT('0' + CONVERT(VARCHAR(2), DATEPART(dd, mpp_bid_next_starttime)), 2) + '/' + RIGHT(DATEPART(yy, mpp_bid_next_starttime), 2) + ' On Call'
            WHEN 'FLOAT' THEN RIGHT('0' + CONVERT(VARCHAR(2), DATEPART(mm, mpp_bid_next_starttime)), 2) + '/' + RIGHT('0' + CONVERT(VARCHAR(2), DATEPART(dd, mpp_bid_next_starttime)), 2) + '/' + RIGHT(DATEPART(yy, mpp_bid_next_starttime), 2) + ' Float'
            WHEN 'ROUTE'  THEN RIGHT('0' + CONVERT(VARCHAR(2), DATEPART(mm, mpp_bid_next_starttime)), 2) + '/' + RIGHT('0' + CONVERT(VARCHAR(2), DATEPART(dd, mpp_bid_next_starttime)), 2) + '/' + RIGHT(DATEPART(yy, mpp_bid_next_starttime), 2) + ' ' + RIGHT('0' + CONVERT(VARCHAR(2), DATEPART(hh, mpp_bid_next_starttime)), 2) + ':' + RIGHT('0' + CONVERT(VARCHAR(2), DATEPART(mi, mpp_bid_next_starttime)), 2) + ' ' + mpp_bid_next_routestore
            WHEN 'STORE'  THEN RIGHT('0' + CONVERT(VARCHAR(2), DATEPART(mm, mpp_bid_next_starttime)), 2) + '/' + RIGHT('0' + CONVERT(VARCHAR(2), DATEPART(dd, mpp_bid_next_starttime)), 2) + '/' + RIGHT(DATEPART(yy, mpp_bid_next_starttime), 2) + ' ' + RIGHT('0' + CONVERT(VARCHAR(2), DATEPART(hh, mpp_bid_next_starttime)), 2) + ':' + RIGHT('0' + CONVERT(VARCHAR(2), DATEPART(mi, mpp_bid_next_starttime)), 2) + ' ' + mpp_bid_next_routestore
            ELSE RIGHT('0' + CONVERT(VARCHAR(2), DATEPART(mm, mpp_bid_next_starttime)), 2) + '/' + RIGHT('0' + CONVERT(VARCHAR(2), DATEPART(dd, mpp_bid_next_starttime)), 2) + '/' + RIGHT(DATEPART(yy, mpp_bid_next_starttime), 2) + ' ' + RIGHT('0' + CONVERT(VARCHAR(2), DATEPART(hh, mpp_bid_next_starttime)), 2) + ':' + RIGHT('0' + CONVERT(VARCHAR(2), DATEPART(mi, mpp_bid_next_starttime)), 2)
         END
   END mpp_bid_next_starttime,       																																									 -- 069
   mpp_senioritydate,                                                                                                  -- 070
   mpp_hours1_week,                                                                                                    -- 071
   ISNULL(mpp_pta_date, '2049-12-31 23:59:59') mpp_pta_date, --DPH PTS 32698                                           -- 072
   exp_affects_avail_dtm,  --JLB PTS 35133                                                                             -- 073
   mpp_comment1,  --JLB PTS 38766                                                                                      -- 074
   --PTS 51918 JJF 20110209                                                                                            
   qualification_list_drv,                                                                                             -- 075
   --END PTS 51918 JJF 20110209,                                                                                       
   --PTS 55760 JJF 20110609                                                                                            
   --ISNULL(mpp_rtw_date, '2049-12-31 23:59:59') mpp_rtw_date                                                          
   mpp_rtw_date,                                                                                                       -- 076
   --END PTS 55760 JJF 20110609                                                                                        
   /* 03/27/2012 MDH PTS 59481: <<BEGIN>> */                                                                           
   mpp_hosstatus,                                                                                                      -- 077
   mpp_hosstatusdate,                                                                                                  -- 078
   mpp_hosactivityupdateon                                                                                             -- 079
   /* 03/27/2012 MDH PTS 59481: <<END>> */                                                                             
   -- BEGIN PTS 60224 SPN                                                                                              
   , mpp_fourteenhrest                                                                                                 -- 080
   -- END PTS 60224 SPN                                                                                                
   , UDF_DRV_1                                                                                                         -- 081
   , UDF_DRV_2                                                                                                         -- 082
   , UDF_DRV_3                                                                                                         -- 083
   ...
   , UDF_DRV_9_t                                                                                                       -- 099
   , UDF_DRV_10_t                                                                                                      -- 100
   , mpp_lastlog_estdate 																																															 -- 101
   , mpp_dailyhrsest                                                                                                   -- 102
   , mpp_weeklyhrsest                                                                                                  -- 103
FROM    #tt
...
GO
GRANT EXECUTE ON  [dbo].[inbound_view_drv] TO [public]
GO
