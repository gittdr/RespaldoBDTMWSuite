...
CREATE PROC [dbo].[d_stlmnt_det_report_general116](
 ...
 *
 * REVISION HISTORY:
 * 09/12/2012.01 ? PTS64478 - TMEZE ? New format based on d_stlmnt_det_report_general.
 *
 **/
...
GO
GRANT EXECUTE ON  [dbo].[d_stlmnt_det_report_general116] TO [public]
GO
