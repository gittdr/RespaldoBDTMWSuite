...
Create PROCEDURE [dbo].[tm_GET_WithoutExactAddressMatch]
	@ToName varchar (50)
 ...
 * 
 * NAME:
 * dbo.[tm_GET_WithoutExactAddressMatch]
 *
 * TYPE:
 * StoredProcedure 
 *
...
/* [tm_GET_WithoutExactAddressMatch]
 **************************************************************
*********************************************************************************/
SET NOCOUNT ON
...
GO
GRANT EXECUTE ON  [dbo].[tm_GET_WithoutExactAddressMatch] TO [public]
GO
