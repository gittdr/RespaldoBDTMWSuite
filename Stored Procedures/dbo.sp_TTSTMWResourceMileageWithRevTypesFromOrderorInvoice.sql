...
CREATE                                                              Procedure [dbo].[sp_TTSTMWResourceMileageWithRevTypesFromOrderorInvoice]
				       (
...
--except Canceled Trip Segments LBK
--This report filters out Canceled Trip Segments regardless
--if they have selected from a list or not selected from the list
--2. Friday November 1, 2002 ver 4.1 
--Took out the hard coded Start Date Restriction for drivers
--and allowed for a choice between Start and End Dates LBK
...
Begin			    --********************************************
   ...
   Begin			 --********************************************
       ...
       where ((@DateType='Start Date' and lgh_startdate between @frmdt and @tdt )
        ...
        Group By legheader.lgh_driver1,lgh_number,lgh_class1,lgh_class2,lgh_class3,lgh_class4,ord_hdrnumber

	--Resolve Any Unknown or Null Rev Types by looking then
	--up if an invoice exists or by order if no invoice exists

	--RevType1 OrderHeader
	Update  #worklist
	        Set lgh_class1 = orderheader.ord_revtype1
	From    orderheader,#worklist
	Where   Not Exists (select * from invoiceheader where orderheader.ord_hdrnumber = invoiceheader.ord_hdrnumber)
		And
		(#worklist.lgh_class1 = 'UNK' or #worklist.lgh_class1 Is Null)
	        And	
		(#worklist.ord_hdrnumber = orderheader.ord_hdrnumber)
		And
		(#worklist.ord_hdrnumber <> 0)	     	

	--select * from #worklist
	
	--RevType1 InvoiceHeader if Invoice Exists
	Update  #worklist
	        Set lgh_class1 = invoiceheader.ivh_revtype1
	From    invoiceheader,#worklist
	Where   --Not Exists (select * from invoiceheader where orderheader.ord_hdrnumber = invoiceheader.ord_hdrnumber)
		--And
		(#worklist.lgh_class1 = 'UNK' or #worklist.lgh_class1 Is Null)
	        And	
		(#worklist.ord_hdrnumber = invoiceheader.ord_hdrnumber)
		And
		(#worklist.ord_hdrnumber <> 0)	
	...
	Update  #worklist
	        Set lgh_class2 = orderheader.ord_revtype2
	From    orderheader,#worklist
	Where   Not Exists (select * from invoiceheader where orderheader.ord_hdrnumber = invoiceheader.ord_hdrnumber)
		And

		(#worklist.lgh_class2 = 'UNK' or #worklist.lgh_class2 Is Null)
	        And	
		(#worklist.ord_hdrnumber = orderheader.ord_hdrnumber)
		And
		(#worklist.ord_hdrnumber <> 0)	     	
	...
	Update  #worklist
	        Set lgh_class2 = invoiceheader.ivh_revtype2
	From    invoiceheader,#worklist
	Where   --Not Exists (select * from invoiceheader where orderheader.ord_hdrnumber = invoiceheader.ord_hdrnumber)
		--And
		(#worklist.lgh_class2 = 'UNK' or #worklist.lgh_class2 Is Null)
	...
	Update  #worklist
	        Set lgh_class3 = orderheader.ord_revtype3
	From    orderheader,#worklist
	Where   Not Exists (select * from invoiceheader where orderheader.ord_hdrnumber = invoiceheader.ord_hdrnumber)
		And
		(#worklist.lgh_class3 = 'UNK' or #worklist.lgh_class3 Is Null)
	        And	
		(#worklist.ord_hdrnumber = orderheader.ord_hdrnumber)
		And
		(#worklist.ord_hdrnumber <> 0)	     	
	...
	Update  #worklist
	        Set lgh_class3 = invoiceheader.ivh_revtype3
	From    invoiceheader,#worklist
	Where   --Not Exists (select * from invoiceheader where orderheader.ord_hdrnumber = invoiceheader.ord_hdrnumber)
		--And
		(#worklist.lgh_class3 = 'UNK' or #worklist.lgh_class3 Is Null)
	...
	Update  #worklist
	        Set lgh_class4 = orderheader.ord_revtype4
	From    orderheader,#worklist
	Where   Not Exists (select * from invoiceheader where orderheader.ord_hdrnumber = invoiceheader.ord_hdrnumber)
		And
		(#worklist.lgh_class4 = 'UNK' or #worklist.lgh_class4 Is Null)
	        And	
		(#worklist.ord_hdrnumber = orderheader.ord_hdrnumber)
		And
		(#worklist.ord_hdrnumber <> 0)	     	
	...
	Update  #worklist
	        Set lgh_class4 = invoiceheader.ivh_revtype4
	From    invoiceheader,#worklist
	Where   --Not Exists (select * from invoiceheader where orderheader.ord_hdrnumber = invoiceheader.ord_hdrnumber)
		--And
		(#worklist.lgh_class4 = 'UNK' or #worklist.lgh_class4 Is Null)
...
where ((@DateType='Start Date' and lgh_startdate between @frmdt and @tdt )
      ...
      And
      (@trctype4 = ',,' OR CHARINDEX(',' + trc_type4  + ',', @trctype4) > 0)
Group By legheader.lgh_tractor,lgh_number,lgh_class1,lgh_class2,lgh_class3,lgh_class4,ord_hdrnumber
...
--Resolve Any Unknown or Null Rev Types by looking then
	...
	Update  #worklist2
	        Set lgh_class1 = orderheader.ord_revtype1
	From    orderheader,#worklist2
	Where   Not Exists (select * from invoiceheader where orderheader.ord_hdrnumber = invoiceheader.ord_hdrnumber)
		And
		(#worklist2.lgh_class1 = 'UNK' or #worklist2.lgh_class1 Is Null)
	        And	
		(#worklist2.ord_hdrnumber = orderheader.ord_hdrnumber)
		And
		(#worklist2.ord_hdrnumber <> 0)	     	

	--select * from #worklist2
	
	--RevType1 InvoiceHeader if Invoice Exists
	Update  #worklist2
	        Set lgh_class1 = invoiceheader.ivh_revtype1
	From    invoiceheader,#worklist2
	Where   --Not Exists (select * from invoiceheader where orderheader.ord_hdrnumber = invoiceheader.ord_hdrnumber)
		--And
		(#worklist2.lgh_class1 = 'UNK' or #worklist2.lgh_class1 Is Null)
	        And	
		(#worklist2.ord_hdrnumber = invoiceheader.ord_hdrnumber)
		And
		(#worklist2.ord_hdrnumber <> 0)	
	...
	Where   Not Exists (select * from invoiceheader where orderheader.ord_hdrnumber = invoiceheader.ord_hdrnumber)
		And
		(#worklist2.lgh_class2 = 'UNK' or #worklist2.lgh_class2 Is Null)
	        And	
		(#worklist2.ord_hdrnumber = orderheader.ord_hdrnumber)
		And
		(#worklist2.ord_hdrnumber <> 0)	     	
	...
	Where   Not Exists (select * from invoiceheader where orderheader.ord_hdrnumber = invoiceheader.ord_hdrnumber)
		And
		(#worklist2.lgh_class3 = 'UNK' or #worklist2.lgh_class3 Is Null)
	        And	
		(#worklist2.ord_hdrnumber = orderheader.ord_hdrnumber)
		And
		(#worklist2.ord_hdrnumber <> 0)	     	
	...
	Where   Not Exists (select * from invoiceheader where orderheader.ord_hdrnumber = invoiceheader.ord_hdrnumber)
		And
		(#worklist2.lgh_class4 = 'UNK' or #worklist2.lgh_class4 Is Null)
	        And	
		(#worklist2.ord_hdrnumber = orderheader.ord_hdrnumber)
		And
		(#worklist2.ord_hdrnumber <> 0)	     	
...
into #finaltractor
from #worklist2
where (@revtype1 = ',,' OR CHARINDEX(',' + lgh_class1 + ',', @revtype1) > 0) 
      And
      (@revtype2 = ',,' OR CHARINDEX(',' + lgh_class2 + ',', @revtype2) > 0) 
      And
      (@revtype3 = ',,' OR CHARINDEX(',' + lgh_class3 + ',', @revtype3) > 0) 
...
GO
GRANT EXECUTE ON  [dbo].[sp_TTSTMWResourceMileageWithRevTypesFromOrderorInvoice] TO [public]
GO
