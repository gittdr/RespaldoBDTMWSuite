...
CREATE PROC [dbo].[d_loadtrl_chassis_sp] @trl varchar(13) , @number int AS
/**
 * 
 * NAME:
 * dbo.d_loadtrl_chassis_sp 
 *
 * TYPE:
 * Stored Procedure
 *
...
GO
GRANT EXECUTE ON  [dbo].[d_loadtrl_chassis_sp] TO [public]
GO
