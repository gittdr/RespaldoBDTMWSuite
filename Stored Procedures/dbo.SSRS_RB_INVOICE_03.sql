...
--if exists (select * from sysobjects where id = object_id('dbo.SSRS_RB_INVOICE_03') and sysstat & 0xf = 4)
--	drop procedure dbo.SSRS_RB_INVOICE_03
--GO

-- exec SSRS_RB_INVOICE_03 1427,1,106,'4/1/2013'

create procedure [dbo].[SSRS_RB_INVOICE_03](@invoice_nbr  	int,@copies		int,@ivs_number	int,@billdate	datetime)
as 
...
select 
	...
	dbo.[TMWSSRS_fcn_referencenumbers_NOCRLF](ivh.ord_hdrnumber,'orderheader') as 'reflist',
	ivs_company,
	ivs_logocompanyname,
	ivs_logocompanyloc
...
GO
GRANT EXECUTE ON  [dbo].[SSRS_RB_INVOICE_03] TO [public]
GO
