...
CREATE PROC [dbo].[d_loadaptrc_sp] @trc varchar(8) , @number int, @parmlist varchar(254) AS
/**
 * 
 * NAME:
 * dbo.d_loadaptrc_sp 
...
GO
GRANT EXECUTE ON  [dbo].[d_loadaptrc_sp] TO [public]
GO
