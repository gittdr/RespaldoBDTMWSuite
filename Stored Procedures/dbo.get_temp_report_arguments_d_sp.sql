...
CREATE PROC [dbo].[get_temp_report_arguments_d_sp]
      ( @temp_report_name           VARCHAR(200)
      , @temp_report_argument_name  VARCHAR(200)
      , @temp_report_argument_value DATETIME   OUTPUT
...
*
* NAME:
* dbo.get_temp_report_arguments_d_sp
*
* TYPE:
* StoredProcedure
*
...
BEGIN
   ...
   Else
      SELECT @temp_report_argument_value = convert(datetime,@temp_report_argument_value_char)
...
END
GO
GRANT EXECUTE ON  [dbo].[get_temp_report_arguments_d_sp] TO [public]
GO
