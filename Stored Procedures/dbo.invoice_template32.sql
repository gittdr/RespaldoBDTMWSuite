...
GO
  ...
  create procedure [dbo].[invoice_template32](@invoice_nbr   int,@copies  int)  
as  
...
UPDATE #invtemp_tbl
   SET ivh_driver  = lgh.lgh_driver1,
       ivh_carrier = lgh.lgh_carrier
  FROM legheader lgh
 WHERE lgh_number = @max_leg
...
return @ret_value  
GO
GRANT EXECUTE ON  [dbo].[invoice_template32] TO [public]
GO
