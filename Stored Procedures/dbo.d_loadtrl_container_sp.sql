...
CREATE PROC [dbo].[d_loadtrl_container_sp] @trl varchar(13) , @number int AS
/**
 * 
 * NAME:
 * dbo.d_loadtrl_container_sp 
 *
 * TYPE:
 * Stored Procedure
 *
...
if exists ( SELECT trl_id FROM trailerprofile WHERE trl_id LIKE @trl + '%' 
	...
	and trl_equipmenttype = 'CONTAINER'
	and trl_status <> 'END'
	--PTS 42816 JJF 20080527
	--PTS 53255 JJF 20101130
...
GO
GRANT EXECUTE ON  [dbo].[d_loadtrl_container_sp] TO [public]
GO
