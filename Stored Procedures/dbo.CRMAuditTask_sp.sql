...
create procedure [dbo].[CRMAuditTask_sp] (@billTo varchar(8), @title as varchar(255), @description as varchar(255)) as
begin
	...
	begin
        ...
        begin
			select @taskDescription = case when isnull(cmp_name, '') <> '' then rtrim(cmp_name) else '' end 
              ...
              from company join city on cty_code = cmp_city 
             where cmp_id = @billto
...
GO
GRANT EXECUTE ON  [dbo].[CRMAuditTask_sp] TO [public]
GO
