 ...
 * 
 * NAME:
 * dbo.d_settlement_sheet_summary_71
 *
 * TYPE:
 * Stored Procedure
 *
 * DESCRIPTION:
 * This settlement sheet doesn't require any YTD so it has been removed.
 * 
 *
 * RETURNS:
 * See selection list.
 ...
 *
 * REVISION HISTORY:
 * 10/23/2006.01 PTS34297 - Phil Bidinger - Creation of proc.
 *
 **/

CREATE PROC [dbo].[d_settlement_sheet_summary_71](
...
/* PRB PTS34297 - No longer needed for this format - YTD will not be used. 
...
GO
GRANT EXECUTE ON  [dbo].[d_settlement_sheet_summary_71] TO [public]
GO
