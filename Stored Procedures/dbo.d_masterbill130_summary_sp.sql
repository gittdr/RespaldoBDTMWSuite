...
CREATE        PROC [dbo].[d_masterbill130_summary_sp] (@reprintflag varchar(10),@mbnumber int,@billto varchar(8), 
...
GO
GRANT EXECUTE ON  [dbo].[d_masterbill130_summary_sp] TO [public]
GO
