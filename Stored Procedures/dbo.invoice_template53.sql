...
GO
  ...
  create procedure [dbo].[invoice_template53](@invoice_nbr   int,@copies  int)
as  
...
05/23/2007 PTS: 36140 Added NON US or USA country to Bill to address
...
declare @temp_name   varchar(30) ,  
 ...
 @temp_country varchar(50),--Added 01/04/07 MRK to support changes in International Mailing requirements PTS#36140  
 @counter    int,  
 @ret_value  int,  
...
invoiceheader.ivh_trailer,     
 ...
 @temp_country cmp_country, --Added 01/04/07 MRK to support changes in International Mailing requirements PTS#36140 
 ivh_hideshipperaddr,  
 ivh_hideconsignaddr,  
...
-- begin  
  ...
  */  
  ...
  set ivh_billto_name = company.cmp_name,  
      ...
      #invtemp_tbl.cmp_country = (case when company.cmp_country in ('US','USA','UNITED STATES','U.S.A','U.S.A.') then '' else IsNull(company.cmp_country,'') end), --Added 01/04/07 MRK to support changes in International Mailing requirements PTS#36140
  ...
  from #invtemp_tbl inner join company on company.cmp_id = #invtemp_tbl.ivh_billto
               left outer join city on company.cmp_city = city.cty_code
 Else   
  update #invtemp_tbl  
  set ivh_billto_name = company.cmp_mailto_name,  
      ...
      cmp_contact = company.cmp_contact  
  from #invtemp_tbl inner join company on company.cmp_id = #invtemp_tbl.ivh_billto
               left outer join city on company.cmp_mailto_city = city.cty_code
 --end  

   --DPH PTS 21798  Adding billto_notes to return set
    update #invtemp_tbl
...
while @counter <>  @copies  
 ...
 select @counter = @counter + 1  
  ...
  cmd_name,  
  cmp_altid,  
  cmp_country, --Added 01/04/07 MRK to support changes in International Mailing requirements PTS#36140
 ivh_hideshipperaddr,  
 ivh_hideconsignaddr,  
 ivh_showshipper,  
 ivh_showcons,  
...
GO
GRANT EXECUTE ON  [dbo].[invoice_template53] TO [public]
GO
