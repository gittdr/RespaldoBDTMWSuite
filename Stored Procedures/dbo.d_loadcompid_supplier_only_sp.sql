...
Create PROC [dbo].[d_loadcompid_supplier_only_sp] @comp varchar(8) , @number int AS

/** 
 * NAME:
 *	dbo.d_loadcompid_supplier_only_sp
 *
 * TYPE:
 *	[StoredProcedure]
 *
 * DESCRIPTION:
 *    Provides data for dddw d_loadcompid_supplier_for_dddw
 *    
 * RETURNS:
 *    Nothing
 *
...
set rowcount 0
GO
GRANT EXECUTE ON  [dbo].[d_loadcompid_supplier_only_sp] TO [public]
GO
