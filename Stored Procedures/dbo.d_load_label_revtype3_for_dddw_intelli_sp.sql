...
CREATE PROC [dbo].[d_load_label_revtype3_for_dddw_intelli_sp]
( @revtype1 VARCHAR(6)
, @revtype2 VARCHAR(6)
) AS
/**
 *
 * NAME:
 * dbo.d_load_label_revtype3_for_dddw_intelli_sp
 *
 * TYPE:
 * StoredProcedure
 *
...
BEGIN
   ...
   INSERT INTO @temp
   EXEC dbo.load_label_sp @name = 'RevType3'
...
END
GO
GRANT EXECUTE ON  [dbo].[d_load_label_revtype3_for_dddw_intelli_sp] TO [public]
GO
