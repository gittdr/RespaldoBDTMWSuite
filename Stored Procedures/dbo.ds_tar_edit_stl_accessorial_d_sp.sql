...
SET ANSI_NULLS ON
GO
CREATE PROCEDURE [dbo].[ds_tar_edit_stl_accessorial_d_sp]
 ...
 *
 * NAME:
 * dbo.ds_tar_edit_stl_accessorial_d_sp
 *
 * TYPE:
 * StoredProcedure
 *
...
BEGIN
   ...
   DELETE FROM tariffaccessorialstl
    WHERE tar_number = @primary_tar_number
   ...
   IF 0 = (SELECT COUNT(1)
      ...
      BEGIN
         ...
         DELETE FROM tariffheaderstl
          WHERE tar_number = @acc_trk_tar_number
      END

END
GO
GRANT EXECUTE ON  [dbo].[ds_tar_edit_stl_accessorial_d_sp] TO [public]
GO
