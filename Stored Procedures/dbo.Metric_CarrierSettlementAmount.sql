...
CREATE PROCEDURE [dbo].[Metric_CarrierSettlementAmount] 
(
	--Standard Parameters
...
/* NOTE: This SQL is used by MetricProcessing to automatically generate an new metric item in a category called NewItems.
	...
	EXEC MetricInitializeItem
		@sMetricCode = 'CarrierSettlementAmount', 
		...
		@sProcedureName = 'Metric_CarrierSettlementAmount',
		@sCachedDetailYN = '',
...
GO
GRANT EXECUTE ON  [dbo].[Metric_CarrierSettlementAmount] TO [public]
GO
