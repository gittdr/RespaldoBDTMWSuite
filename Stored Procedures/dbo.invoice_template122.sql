...
GO
  ...
  create  procedure [dbo].[invoice_template122](@invoice_nbr   int,   @copies  int)  
as  
/*
*
* 
* NAME:invoice_template122
* dbo.invoice_template122
*
* TYPE:
* StoredProcedure
*
...
return @ret_value  
GO
GRANT EXECUTE ON  [dbo].[invoice_template122] TO [public]
GO
