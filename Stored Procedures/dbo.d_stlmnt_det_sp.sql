...
Create Procedure [dbo].[d_stlmnt_det_sp] (@type CHAR(6), @id CHAR(13), @lghnumber INT, @ordnum INT)
AS
 ...
 *  11/14/2012	vjh 63106 add pyt_garnishmentclassification
 * 10/02/2012 PTS62995 SPN - add col pyd_atd_id (Tour Detail ID)
 * 10/29/2013	vjh	71977 add pyt_AdjustWithNegativePay, pyt_sth_abbr, sth_priority, pyt_sth_priority, pyd_pair, pyd_branch
 * 05/14/2014 NQIAO PTS76582 - add 2 new outputs: pyd_fixedrate, pyd_fixedamount
...
CREATE TABLE #temp_pay(
	...
	tar_tarriffnumbe	VARCHAR(12) NULL,
	...
	pyd_fixedrate					char(1)		NULL,	-- NQIAO PTS76582
	pyd_fixedamount					char(1)		NULL,	-- NQIAO PTS76582
	pyd_orig_currency				varchar(6)	NULL,	-- NQIAO PTS63702
	pyd_orig_amount					money		NULL,	-- NQIAO PTS63702
	pyd_cex_rate					money		NULL,	-- NQIAO PTS 63702
...
END
GO
GRANT EXECUTE ON  [dbo].[d_stlmnt_det_sp] TO [public]
GO
