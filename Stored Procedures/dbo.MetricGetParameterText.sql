...
SET ANSI_NULLS ON
GO
CREATE PROCEDURE [dbo].[MetricGetParameterText] 
(
	@ParmValue varchar(255) OUTPUT,
...
AS
	...
	BEGIN
		SELECT @ParmValue = (SELECT ParmValue
...
GO
GRANT EXECUTE ON  [dbo].[MetricGetParameterText] TO [public]
GO
