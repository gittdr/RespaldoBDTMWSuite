...
CREATE PROC [dbo].[d_settlement_sheet_summary_88](
...
/**
 * DESCRIPTION:
 * Created for PTS 39688 - vjh - Proc copied from d_settlement_sheet_summary_25 and modified to meet
 * SR requirements
 *
 * PARAMETERS:
 *
 ...
 *
 * REVISION HISTORY:
 * 01/16/2008.01 ? PTS39688 - vjh ? copy from format 25
 * 03/13/2008.01 - PTS41736 - vjh - add YTD GST calcs
 *
 **/
...
GO
GRANT EXECUTE ON  [dbo].[d_settlement_sheet_summary_88] TO [public]
GO
