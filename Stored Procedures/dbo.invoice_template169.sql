...
create procedure [dbo].[invoice_template169](@invoice_nbr int,@copies int)  
as 
/*
*
* 
* NAME:invoice_template169
* dbo.invoice_template169
*
* TYPE:
* StoredProcedure
*
...
GO
GRANT EXECUTE ON  [dbo].[invoice_template169] TO [public]
GO
