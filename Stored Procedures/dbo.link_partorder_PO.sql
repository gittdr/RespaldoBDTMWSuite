...
CREATE PROCEDURE [dbo].[link_partorder_PO] @p_num INT
AS
BEGIN
...
if @debug > 0 print 'End Date:' + convert(varchar(30), @enddate_limit)

select @v_porid = 0

-- Create the list of part order details (routes) to process. There may be more than 1!
INSERT INTO @unlinked_por
SELECT por_identity
FROM partorder_routing
WHERE poh_identity = @p_num 
...
GO
GRANT EXECUTE ON  [dbo].[link_partorder_PO] TO [public]
GO
