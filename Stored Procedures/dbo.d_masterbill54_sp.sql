...
CREATE PROC [dbo].[d_masterbill54_sp] (@reprintflag varchar(10),@mbnumber int,@billto varchar(8), 
 ...
 * 
 * NAME:
 * dbo.d_masterbill54_sp
 *
 * TYPE:
 * StoredProcedure
 *
 * DESCRIPTION:
 * Return data for Masterbill 54
 *
 * RETURNS:
 * na
 *
 ...
 * 10/19/2005.01 - Vince Herman ? Add count and currency label
 * 01/30/2006 - PTS# 30885 - Imari Bremer - use the ivh_currency in place of ivh_arcurrency
 *
 **/
...
select @rte_ref_number = ref_number
    from referencenumber
...
GO
GRANT EXECUTE ON  [dbo].[d_masterbill54_sp] TO [public]
GO
