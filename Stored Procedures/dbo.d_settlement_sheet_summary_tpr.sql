...
*/
/****** Object:  Stored Procedure dbo.d_settlement_sheet_summary_tpr    Script Date: 6/24/98 10:17:22 AM ******/
CREATE PROC [dbo].[d_settlement_sheet_summary_tpr](
	...
	@drv_id varchar(8),
	@trc_id varchar(13),	
	@trl_id varchar(13),	-- PTS 19738 - DJM - Expanded to 13 characters
	@drv_type1 varchar(6),
	@trc_type1 varchar(6),
	@trl_type1 varchar(6),
	@terminal varchar(8),
...
GO
GRANT EXECUTE ON  [dbo].[d_settlement_sheet_summary_tpr] TO [public]
GO
