...
CREATE PROC [dbo].[d_settlement_sheet_summary43a](
...
/* JET need to pull the fee straight from the pay details, 5/14/99 --Update the temp pay details with paytype data
...
update #temp_pd set itemsection = 99 where pyd_pretax = 'E' --28501 JD
...
SELECT pyd_number, 
	...
	'' 'crd_cardnumber',--ph.crd_cardnumber 'crd_cardnumber',
	lgh_startdate,
	std_balance,
	itemsection,
	ord_startdate,
...
GO
GRANT EXECUTE ON  [dbo].[d_settlement_sheet_summary43a] TO [public]
GO
