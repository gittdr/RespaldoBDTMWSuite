...
CREATE PROCEDURE [dbo].[sp_act_casetasykms_sayer_JR]
(
	@P_NumOrden		integer
)
	...
	begin tran
				...
				BEGIN
					...
					Begin
						...
						execute dbo.miles_between_CasetasJR   @type = 7, @o_cmp = @v_cmp_orig_ant, @d_cmp = @v_cmp_dest, @o_cty = @V_cty_orig_ant, @d_cty = @V_cty_dest, @o_zip = '0', @d_zip = '0', @haztype = 0,@casetas = @v_casetas output, @kilometros = @v_kms output
