...
create PROC [dbo].[d_loadbillcompid_sp] @comp varchar(8) , @number int, @parmlist varchar(254) AS
...
--PTS 53255 JJF 20101130
DECLARE @tbl_cmprestrictedcustom TABLE(Value VARCHAR(8) primary key)
...
GO
GRANT EXECUTE ON  [dbo].[d_loadbillcompid_sp] TO [public]
GO
