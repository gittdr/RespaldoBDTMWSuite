...
CREATE PROC [dbo].[d_settlement_sheet_summary15] (
...
-- JD 32412 commented out the following lines
...
-- 	       AND oh.ord_consignee = co.cmp_id
--	       AND co.cmp_city = ct.cty_code
-- JD 32412 JD end commented out section
...
GO
GRANT EXECUTE ON  [dbo].[d_settlement_sheet_summary15] TO [public]
GO
