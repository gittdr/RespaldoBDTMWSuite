...
-- this proc created to provide a list of shipper companies
-- only for the shipper company dddw 
--

create PROC [dbo].[d_loadshipcompid_sp] @comp varchar(8) , @number int AS
...
GO
GRANT EXECUTE ON  [dbo].[d_loadshipcompid_sp] TO [public]
GO
