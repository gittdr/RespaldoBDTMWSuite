...
CREATE Proc [dbo].[Metric_UnbilledRevEstTotal2]
	(	
		--Standard Parameters
...
/* Version History
3/2008:	Added DrvType1-4 to parameter list
...
/* NOTE: This SQL is used by MetricProcessing to automatically generate an new metric item in a category called NewItems.
	...
	EXEC MetricInitializeItem
		@sMetricCode = 'UnbilledRevEstTotal2',
		...
		@nPlusDeltaIsGood = 0,
		@nCumulative = 0,
		@sCaption = 'Unbilled Revenue2',
		@sCaptionFull = 'Estimate unbilled revenue2',
		@sProcedureName = 'Metric_UnbilledRevEstTotal2',
		@sCachedDetailYN = '',
...
*/
	...
	FROM orderheader (NOLOCK) Join manpowerprofile (NOLOCK) on orderheader.ord_driver1 = manpowerprofile.mpp_id
	...
	Set @TotalBillMilesLast60Days = 	(
											...
											From Invoiceheader (NOLOCK) Join manpowerprofile (NOLOCK) on Invoiceheader.ivh_driver = manpowerprofile.mpp_id
...
GO
GRANT EXECUTE ON  [dbo].[Metric_UnbilledRevEstTotal2] TO [public]
GO
