...
CREATE procedure [dbo].[d_tripfolder_11_sp]
	@mov_number integer
as
/**
 *
 ...
 * 251 - trl1_prefix
 * 252 - trl2_prefix
 * 253 - revtype1_description	VARCHAR(20) NULL		// 01/06/2009 MDH PTS 44898: Added
 * 254 - revtype2_description	VARCHAR(20) NULL		// 01/06/2009 MDH PTS 44898: Added
 * 255 - revtype3_description	VARCHAR(20) NULL		// 01/06/2009 MDH PTS 44898: Added
 * 256 - revtype4_description	VARCHAR(20) NULL		// 01/06/2009 MDH PTS 44898: Added
 * 257 - revtype1_extra1		VARCHAR(60) NULL		// 01/06/2009 MDH PTS 44898: Added
 * 258 - revtype2_extra1		VARCHAR(60) NULL		// 01/06/2009 MDH PTS 44898: Added
 * 259 - revtype3_extra1		VARCHAR(60) NULL		// 01/06/2009 MDH PTS 44898: Added
 * 260 - revtype4_extra1		VARCHAR(60) NULL		// 01/06/2009 MDH PTS 44898: Added
 *
 * PARAMETERS:
 ...
 *
 * REVISION HISTORY:
 *     01/06/2009 MDH PTS 44898: Copied from d_tripfolder_sp.sql
 *	   07/13/2012 TMEZE PTS 61575: Barcode not printed all of the time ->
 *								   obtained first orderheader number for the move instead of 0 for non order based stops
 **/
...
CREATE TABLE #temp (
	...
	revtype1_description	VARCHAR(20) NULL,
	revtype2_description	VARCHAR(20) NULL,
	revtype3_description	VARCHAR(20) NULL,
	revtype4_description	VARCHAR(20) NULL,
	revtype1_extra1		VARCHAR(60) NULL,
	revtype2_extra1		VARCHAR(60) NULL,
	revtype3_extra1		VARCHAR(60) NULL,
	revtype4_extra1		VARCHAR(60) NULL
)
...
if Left(@localization,1) <> 'Y'
	Begin
		...
		SELECT event.evt_driver1 driver1, 
			...
			rev1.name,  /* 01/06/2009 MDH PTS 44898: Added */
			rev2.name,  /* 01/06/2009 MDH PTS 44898: Added */
			rev3.name,  /* 01/06/2009 MDH PTS 44898: Added */
			rev4.name,  /* 01/06/2009 MDH PTS 44898: Added */
			rev1.label_extrastring1, /* 01/06/2009 MDH PTS 44898: Added */
			rev2.label_extrastring1, /* 01/06/2009 MDH PTS 44898: Added */
			rev3.label_extrastring1, /* 01/06/2009 MDH PTS 44898: Added */
			rev4.label_extrastring1 /* 01/06/2009 MDH PTS 44898: Added */
		--pts40187 jguo outer join conversion
		FROM stops  LEFT OUTER JOIN  city  ON  stops.stp_city  = city.cty_code   
					LEFT OUTER JOIN  legheader  ON  stops.lgh_number  = legheader.lgh_number   
					LEFT OUTER JOIN  orderheader  ON  stops.ord_hdrnumber  = orderheader.ord_hdrnumber 
--PTS 61575 start					 
----					LEFT OUTER JOIN  labelfile rev1 ON orderheader.ord_revtype1 = rev1.abbr AND rev1.labeldefinition = 'RevType1'		/* 01/06/2009 MDH PTS 44898: Added */
----					LEFT OUTER JOIN  labelfile rev2 ON orderheader.ord_revtype2 = rev2.abbr AND rev2.labeldefinition = 'RevType2'		/* 01/06/2009 MDH PTS 44898: Added */
----					LEFT OUTER JOIN  labelfile rev3 ON orderheader.ord_revtype3 = rev3.abbr AND rev3.labeldefinition = 'RevType3'		/* 01/06/2009 MDH PTS 44898: Added */
----					LEFT OUTER JOIN  labelfile rev4 ON orderheader.ord_revtype4 = rev4.abbr AND rev4.labeldefinition = 'RevType4',	/* 01/06/2009 MDH PTS 44898: Added */

     LEFT OUTER JOIN  labelfile rev1 ON (select ord_revtype1 from orderheader where ord_hdrnumber = (select top 1 ord_hdrnumber from stops where mov_number = @mov_number and ord_hdrnumber > 0 order by stp_mfh_sequence)) = rev1.abbr AND rev1.labeldefinition = 'RevType1'
     LEFT OUTER JOIN  labelfile rev2 ON (select ord_revtype2 from orderheader where ord_hdrnumber = (select top 1 ord_hdrnumber from stops where mov_number = @mov_number and ord_hdrnumber > 0 order by stp_mfh_sequence)) = rev2.abbr AND rev2.labeldefinition = 'RevType2'
     LEFT OUTER JOIN  labelfile rev3 ON (select ord_revtype3 from orderheader where ord_hdrnumber = (select top 1 ord_hdrnumber from stops where mov_number = @mov_number and ord_hdrnumber > 0 order by stp_mfh_sequence)) = rev3.abbr AND rev3.labeldefinition = 'RevType3'
     LEFT OUTER JOIN  labelfile rev4 ON (select ord_revtype4 from orderheader where ord_hdrnumber = (select top 1 ord_hdrnumber from stops where mov_number = @mov_number and ord_hdrnumber > 0 order by stp_mfh_sequence)) = rev4.abbr AND rev4.labeldefinition = 'RevType4',   
--PTS 61575 end
			event,
			freightdetail,
			eventcodetable
...
GO
GRANT EXECUTE ON  [dbo].[d_tripfolder_11_sp] TO [public]
GO
