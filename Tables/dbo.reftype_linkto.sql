CREATE TABLE [dbo].[reftype_linkto]
(
[ref_type_linkto_id] [int] NOT NULL IDENTITY(1, 1),
[ref_type] [varchar] (6) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
...
CREATE TRIGGER [dbo].[itut_reftype_linkto]
ON [dbo].[reftype_linkto]
FOR INSERT,UPDATE
AS  
...
DECLARE @ref_type_linkto_id      INT
...
RETURN
GO
ALTER TABLE [dbo].[reftype_linkto] ADD CONSTRAINT [pk_ref_type_linkto_id] PRIMARY KEY CLUSTERED ([ref_type_linkto_id]) ON [PRIMARY]
GO
GRANT DELETE ON  [dbo].[reftype_linkto] TO [public]
GO
GRANT INSERT ON  [dbo].[reftype_linkto] TO [public]
GO
GRANT REFERENCES ON  [dbo].[reftype_linkto] TO [public]
GO
GRANT SELECT ON  [dbo].[reftype_linkto] TO [public]
GO
GRANT UPDATE ON  [dbo].[reftype_linkto] TO [public]
GO
