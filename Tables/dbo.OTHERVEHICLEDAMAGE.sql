...
[INS_TIMESTAMP] [datetime2] (0) NOT NULL CONSTRAINT [DF__OTHERVEHI__INS_T__65ABC9F7] DEFAULT (getdate())
) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [idx_OTHERVEHICLEDAMAGE_timestamp] ON [dbo].[OTHERVEHICLEDAMAGE] ([dw_timestamp]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [OTHERVEHICLEDAMAGE_INS_TIMESTAMP] ON [dbo].[OTHERVEHICLEDAMAGE] ([INS_TIMESTAMP] DESC) ON [PRIMARY]
GO
