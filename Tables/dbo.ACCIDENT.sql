...
[INS_TIMESTAMP] [datetime2] (0) NOT NULL CONSTRAINT [DF__ACCIDENT__INS_TI__313801B8] DEFAULT (getdate())
) ON [PRIMARY]
GO
...
GO
CREATE NONCLUSTERED INDEX [ACCIDENT_INS_TIMESTAMP] ON [dbo].[ACCIDENT] ([INS_TIMESTAMP] DESC) ON [PRIMARY]
GO
