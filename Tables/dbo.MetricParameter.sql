CREATE TABLE [dbo].[MetricParameter]
(
...
GO
ALTER TABLE [dbo].[MetricParameter] ADD CONSTRAINT [PK__MetricParameter__6CD8EFF2] PRIMARY KEY NONCLUSTERED ([sn]) ON [PRIMARY]
GO
ALTER TABLE [dbo].[MetricParameter] ADD CONSTRAINT [idxMetricParameter] UNIQUE NONCLUSTERED ([Heading], [SubHeading], [ParmName]) ON [PRIMARY]
GO
