CREATE TABLE [dbo].[MR_ReportingRestrictionsSubsidiary]
(
...
GO
ALTER TABLE [dbo].[MR_ReportingRestrictionsSubsidiary] ADD CONSTRAINT [PK_MR_ReportingRestrictionsSubsidiary] PRIMARY KEY CLUSTERED ([re_reportname], [re_sequence], [re_innersequence]) ON [PRIMARY]
GO
GRANT DELETE ON  [dbo].[MR_ReportingRestrictionsSubsidiary] TO [public]
GO
GRANT INSERT ON  [dbo].[MR_ReportingRestrictionsSubsidiary] TO [public]
GO
GRANT REFERENCES ON  [dbo].[MR_ReportingRestrictionsSubsidiary] TO [public]
GO
GRANT SELECT ON  [dbo].[MR_ReportingRestrictionsSubsidiary] TO [public]
GO
GRANT UPDATE ON  [dbo].[MR_ReportingRestrictionsSubsidiary] TO [public]
GO
