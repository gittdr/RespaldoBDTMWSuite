...
CREATE            View [dbo].[vTTSTMW_DriverComplaints]
...
SELECT     drivercomplaint.mpp_id as 'Driver ID', 
	   ...
	   mpp_type3 as 'DrvType3', 
           ...
           Case When (Select mpp_terminationdt from manpowerprofile (NOLOCK) where drivercomplaint.mpp_id = manpowerprofile.mpp_id) > GetDate() Then 
                 'Y' 
           Else 
                 'N' 
           End As 'ActiveYN',
...
FROM       dbo.drivercomplaint (NOLOCK) Inner Join manpowerprofile (NOLOCK) On manpowerprofile.mpp_id = drivercomplaint.mpp_id
...
GO
GRANT SELECT ON  [dbo].[vTTSTMW_DriverComplaints] TO [public]
GO
