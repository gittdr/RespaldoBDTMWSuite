...
SET ANSI_NULLS ON
GO
CREATE view [dbo].[CarrierHubAvailableLoadsView]
as
...
GO
GRANT DELETE ON  [dbo].[CarrierHubAvailableLoadsView] TO [public]
GO
GRANT INSERT ON  [dbo].[CarrierHubAvailableLoadsView] TO [public]
GO
GRANT SELECT ON  [dbo].[CarrierHubAvailableLoadsView] TO [public]
GO
GRANT UPDATE ON  [dbo].[CarrierHubAvailableLoadsView] TO [public]
GO
