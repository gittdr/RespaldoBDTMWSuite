...
CREATE  view [dbo].[vSSRSRB_DriverViolations]
As

/**
 *
 * NAME:
 * dbo.vSSRSRB_DriverViolations
 *
 * TYPE:
 * View
 *
 * DESCRIPTION:
 * Retrieve Data for DriverViolation 
 *
 *
 * REVISION HISTORY:
 *
...
FROM  dbo.driverlogviolation WITH (NOLOCK) Inner Join manpowerprofile WITH (NOLOCK) On manpowerprofile.mpp_id = driverlogviolation.mpp_id
             
GO
GRANT DELETE ON  [dbo].[vSSRSRB_DriverViolations] TO [public]
GO
GRANT INSERT ON  [dbo].[vSSRSRB_DriverViolations] TO [public]
GO
GRANT REFERENCES ON  [dbo].[vSSRSRB_DriverViolations] TO [public]
GO
GRANT SELECT ON  [dbo].[vSSRSRB_DriverViolations] TO [public]
GO
GRANT UPDATE ON  [dbo].[vSSRSRB_DriverViolations] TO [public]
GO
