...
CREATE VIEW [dbo].[HVLISiteManagementDetailView]
AS
  SELECT DISTINCT
...
GO
GRANT INSERT ON  [dbo].[HVLISiteManagementDetailView] TO [public]
GO
GRANT SELECT ON  [dbo].[HVLISiteManagementDetailView] TO [public]
GO
GRANT UPDATE ON  [dbo].[HVLISiteManagementDetailView] TO [public]
GO
