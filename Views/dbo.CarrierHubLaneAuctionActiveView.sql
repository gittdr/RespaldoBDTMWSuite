...
create view [dbo].[CarrierHubLaneAuctionActiveView]
as
select 'TMWWF_CarrierHub_LANEAUCTION_ACTIVE' AS 'TMWWF_CarrierHub_LANEAUCTION_ACTIVE',
...
GO
GRANT DELETE ON  [dbo].[CarrierHubLaneAuctionActiveView] TO [public]
GO
GRANT INSERT ON  [dbo].[CarrierHubLaneAuctionActiveView] TO [public]
GO
GRANT SELECT ON  [dbo].[CarrierHubLaneAuctionActiveView] TO [public]
GO
GRANT UPDATE ON  [dbo].[CarrierHubLaneAuctionActiveView] TO [public]
GO
