...
create view [dbo].[TMWScrollOrderView] AS
...
FROM RowSecuredOrderheaderNoLockView orderheader
...
GO
GRANT DELETE ON  [dbo].[TMWScrollOrderView] TO [public]
GO
GRANT INSERT ON  [dbo].[TMWScrollOrderView] TO [public]
GO
GRANT SELECT ON  [dbo].[TMWScrollOrderView] TO [public]
GO
GRANT UPDATE ON  [dbo].[TMWScrollOrderView] TO [public]
GO
