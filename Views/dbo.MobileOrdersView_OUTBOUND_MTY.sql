...
CREATE view [dbo].[MobileOrdersView_OUTBOUND_MTY]
AS

/*******************************************************************************************************************  
SELECT * FROM MobileOrdersView_MTY
*******************************************************************************************************************/
...
AND ord.ord_hdrnumber in (SELECT ord_hdrnumber FROM legheader WHERE lgh_outstatus in ('AVL','PLN','STD') AND lgh_startregion1 in ('MT','CH'))
AND ord.ord_revtype3 IN ('BAJ','FULO','FULM','NOR','INTER')-- AND ord.ord_revtype4 IN('INT','SEN')
