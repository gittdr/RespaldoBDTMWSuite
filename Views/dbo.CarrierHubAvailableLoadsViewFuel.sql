...
SET ANSI_NULLS ON
GO
CREATE view [dbo].[CarrierHubAvailableLoadsViewFuel]
as
select 'TMWWF_CarrierHub_AVAILABLE' AS 'TMWWF_CarrierHub_AVAILABLE',
...
GO
GRANT DELETE ON  [dbo].[CarrierHubAvailableLoadsViewFuel] TO [public]
GO
GRANT INSERT ON  [dbo].[CarrierHubAvailableLoadsViewFuel] TO [public]
GO
GRANT SELECT ON  [dbo].[CarrierHubAvailableLoadsViewFuel] TO [public]
GO
GRANT UPDATE ON  [dbo].[CarrierHubAvailableLoadsViewFuel] TO [public]
GO
