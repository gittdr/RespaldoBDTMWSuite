...
SET ANSI_NULLS ON
GO
create view [dbo].[EstatActiveOrdersViewFuel]
as
select 
 ...
 ord.ord_revtype1 'RevType1', 
 ord.ord_revtype2 'RevType2', 
 ord.ord_revtype3 'RevType3', 
 ord.ord_revtype4 'RevType4',
 fgt1.fgt_supplier 'Supplier1',
...
GO
GRANT INSERT ON  [dbo].[EstatActiveOrdersViewFuel] TO [public]
GO
GRANT SELECT ON  [dbo].[EstatActiveOrdersViewFuel] TO [public]
GO
GRANT UPDATE ON  [dbo].[EstatActiveOrdersViewFuel] TO [public]
GO
