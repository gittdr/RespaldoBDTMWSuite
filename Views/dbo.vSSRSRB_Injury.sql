...
CREATE  View  [dbo].[vSSRSRB_Injury]
As
...
From    vSSRSRB_SafetyReport WITH (NOLOCK) Inner Join Injury WITH (NOLOCK) On Injury.srp_ID = vSSRSRB_SafetyReport.[Rpt Report ID]
...
GO
GRANT SELECT ON  [dbo].[vSSRSRB_Injury] TO [public]
GO
