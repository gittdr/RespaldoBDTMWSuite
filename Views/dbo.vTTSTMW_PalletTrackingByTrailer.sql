...
CREATE              View [dbo].[vTTSTMW_PalletTrackingByTrailer]
...
Select
	...
	[Branch] = (Select trl_branch from trailerprofile (NOLOCK) where pt_trailer_number = trailerprofile.trl_id)
...
GO
GRANT SELECT ON  [dbo].[vTTSTMW_PalletTrackingByTrailer] TO [public]
GO
