...
CREATE  View [dbo].[vSSRSRB_ServiceException]
AS

/**
 *
 * NAME:
 * dbo.vSSRSRB_ServiceException
 *
 * TYPE:
 * View
 *
 * DESCRIPTION:
 * Retrieve ServiceException Data 
 *
 *
 * REVISION HISTORY:
 *
...
GO
GRANT SELECT ON  [dbo].[vSSRSRB_ServiceException] TO [public]
GO
