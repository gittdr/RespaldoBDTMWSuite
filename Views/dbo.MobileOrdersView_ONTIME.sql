...
CREATE view [dbo].[MobileOrdersView_ONTIME]
AS

/*******************************************************************************************************************  
SELECT * FROM MobileOrdersView_ONTIME
*******************************************************************************************************************/
...
AND lgh_startregion1 in ('MT','CH','CU','GD','MA','MX','NV','PB','QR','TJ','VH','VZ'))
AND ord.ord_revtype3 in ('BAJ','FULO','FULM','NOR','PPG','TOL','FULS')
