...
CREATE view [dbo].[CarrierHubMobileAvailableLoadsView]
as
select 'TMWWF_CarrierHubMobile_AVAILABLE' AS 'TMWWF_CarrierHubMobile_AVAILABLE',
	leg.lgh_number,  
	leg.ord_hdrnumber,
...
GO
GRANT DELETE ON  [dbo].[CarrierHubMobileAvailableLoadsView] TO [public]
GO
GRANT INSERT ON  [dbo].[CarrierHubMobileAvailableLoadsView] TO [public]
GO
GRANT SELECT ON  [dbo].[CarrierHubMobileAvailableLoadsView] TO [public]
GO
GRANT UPDATE ON  [dbo].[CarrierHubMobileAvailableLoadsView] TO [public]
GO
