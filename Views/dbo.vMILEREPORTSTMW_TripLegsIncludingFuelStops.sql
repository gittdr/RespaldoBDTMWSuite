...
--select top 500 * from vMILEREPORTSTMW_TripLegsIncludingFuelStops where [Mov_number] = 3043 order by [arrival date]

CREATE                            View [dbo].[vMILEREPORTSTMW_TripLegsIncludingFuelStops] As
...
GO
GRANT SELECT ON  [dbo].[vMILEREPORTSTMW_TripLegsIncludingFuelStops] TO [public]
GO
