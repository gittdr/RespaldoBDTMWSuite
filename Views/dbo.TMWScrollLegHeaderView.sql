...
SET ANSI_NULLS ON
GO
create view [dbo].[TMWScrollLegHeaderView] AS
...
SELECT 
	...
	dbo.TMW_AllocateLegRevenue(leg.lgh_number, orderheader.ord_charge) as 'ord_charge_allocated', 
	dbo.TMW_AllocateLegRevenue(leg.lgh_number, orderheader.ord_totalcharge) as 'ord_totalcharge_allocated', 
	dbo.TMW_AllocateLegRevenue(leg.lgh_number,orderheader.ord_accessorial_chrg) as 'ord_accessorial_chrg_allocated'
...
GO
GRANT SELECT ON  [dbo].[TMWScrollLegHeaderView] TO [public]
GO
