...
CREATE view [dbo].[TMWScrollOrderViewTatiana] AS
...
SELECT  DISTINCT orderheader.ord_number, 
	...
	(select isNull(sum(lgh_miles),0) from legheader as lgh where lgh.ord_hdrnumber = orderheader.ord_hdrnumber) as 'kmstotales'
...
GO
GRANT SELECT ON  [dbo].[TMWScrollOrderViewTatiana] TO [public]
GO
