...
CREATE View [dbo].[vTTSTMW_OrderSchedules]

As

Select  vTTSTMW_OrderInformation.*,
	[sch_number]  as [Schedule Number],
	[sch_description] as [Schedule Description],
	[ord_hdrnumber] as [Schedule Order Header Number],
...
From    schedule_table (NOLOCK), vTTSTMW_OrderInformation

Where   schedule_table.[ord_hdrnumber] = [Order Header Number]


--grant select on vTTSTMW_OrderSchedules to public


GO
GRANT SELECT ON  [dbo].[vTTSTMW_OrderSchedules] TO [public]
GO
