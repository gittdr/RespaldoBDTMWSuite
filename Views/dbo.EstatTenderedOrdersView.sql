...
SET ANSI_NULLS ON
GO
CREATE view [dbo].[EstatTenderedOrdersView]
as select 
...
GO
GRANT INSERT ON  [dbo].[EstatTenderedOrdersView] TO [public]
GO
GRANT SELECT ON  [dbo].[EstatTenderedOrdersView] TO [public]
GO
GRANT UPDATE ON  [dbo].[EstatTenderedOrdersView] TO [public]
GO
