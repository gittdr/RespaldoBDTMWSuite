...
CREATE VIEW [dbo].[vTTSTMW_AssetAssignmentTractor]
...
From assetassignment a (NOLOCK) left join vTTSTMW_RevVsPay r  on a.lgh_number = r.[Leg Header Number] where asgn_type = 'TRC'
...
GO
GRANT SELECT ON  [dbo].[vTTSTMW_AssetAssignmentTractor] TO [public]
GO
