...
CREATE              View [dbo].[vTTSTMW_PalletTrackingByCarrier]
...
Select
	...
	[Branch] = (Select car_branch from carrier (NOLOCK) where pt_carrier_id = carrier.car_id)
...
GO
GRANT SELECT ON  [dbo].[vTTSTMW_PalletTrackingByCarrier] TO [public]
GO
