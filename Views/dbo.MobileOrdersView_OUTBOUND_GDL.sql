...
CREATE view [dbo].[MobileOrdersView_OUTBOUND_GDL]
AS

/*******************************************************************************************************************  
SELECT * FROM MobileOrdersView_GDA
*******************************************************************************************************************/
...
AND ord.ord_hdrnumber in (SELECT ord_hdrnumber FROM legheader WHERE lgh_outstatus in ('AVL','PLN','STD') AND lgh_startregion1 in ('CU','GD','TJ'))
AND ord.ord_revtype3 IN ('BAJ','PEÑ','INTER') AND ord.ord_revtype4 IN('INT','SEN')
