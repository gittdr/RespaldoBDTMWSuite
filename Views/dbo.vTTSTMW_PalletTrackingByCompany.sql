...
CREATE              View [dbo].[vTTSTMW_PalletTrackingByCompany]
...
Select
	...
	[Branch] = (Select ord_booked_revtype1 from orderheader (NOLOCK) where orderheader.ord_number = pt_ord_number)
...
GO
GRANT SELECT ON  [dbo].[vTTSTMW_PalletTrackingByCompany] TO [public]
GO
