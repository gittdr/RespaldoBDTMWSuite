...
SET ANSI_NULLS ON
GO
CREATE view [dbo].[EstatActiveOrdersView]
as
select 
...
GO
GRANT INSERT ON  [dbo].[EstatActiveOrdersView] TO [public]
GO
GRANT SELECT ON  [dbo].[EstatActiveOrdersView] TO [public]
GO
GRANT UPDATE ON  [dbo].[EstatActiveOrdersView] TO [public]
GO
