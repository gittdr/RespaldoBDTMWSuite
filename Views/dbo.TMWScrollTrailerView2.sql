...
create view [dbo].[TMWScrollTrailerView2] AS
SELECT
trl_number,
trl_id,
cmp_id,
...
FROM	dbo.trailerprofile (NOLOCK) 
		...
		LEFT OUTER JOIN dbo.city AvailableCity (NOLOCK) ON dbo.trailerprofile.trl_avail_city = AvailableCity.cty_code 
		LEFT OUTER JOIN dbo.city PlannedCity (NOLOCK) ON dbo.trailerprofile.trl_next_city = PlannedCity.cty_code 
GO
GRANT DELETE ON  [dbo].[TMWScrollTrailerView2] TO [public]
GO
GRANT INSERT ON  [dbo].[TMWScrollTrailerView2] TO [public]
GO
GRANT REFERENCES ON  [dbo].[TMWScrollTrailerView2] TO [public]
GO
GRANT SELECT ON  [dbo].[TMWScrollTrailerView2] TO [public]
GO
GRANT UPDATE ON  [dbo].[TMWScrollTrailerView2] TO [public]
GO
