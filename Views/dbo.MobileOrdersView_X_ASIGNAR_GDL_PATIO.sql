...
CREATE view [dbo].[MobileOrdersView_X_ASIGNAR_GDL_PATIO]
AS

/*******************************************************************************************************************  
SELECT * FROM MobileOrdersView_GDAPATIO
*******************************************************************************************************************/
...
AND lgh_startregion1 in ('GD','CU','TJ'))
AND ord.ord_revtype3 in ('BAJ','HYS','FULO','NOR','FULS')
