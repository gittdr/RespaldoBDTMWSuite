...
CREATE VIEW [dbo].[OperationsDriverView_sinexp] AS  
 SELECT  manpowerprofile.mpp_id                  mpp_id,  
  ...
  manpowerprofile.mpp_pta_date [PTA Date], --DPH PTS 32698  
   ...
   and mpp_id not in (select exp_id from expiration where exp_idtype = 'DRV' and exp_completed = 'N'
   and exp_code <> 'LIC')

GO
GRANT SELECT ON  [dbo].[OperationsDriverView_sinexp] TO [public]
GO
