...
CREATE VIEW [dbo].[TMWScrollCompute3PLBillingOrdersView]
AS
...
FROM orderheader (NOLOCK)
  INNER JOIN TMWOrdersCostDetailGenOnDemandView ON TMWOrdersCostDetailGenOnDemandView.ord_hdrnumber = orderheader.ord_hdrnumber
...
GO
GRANT DELETE ON  [dbo].[TMWScrollCompute3PLBillingOrdersView] TO [public]
GO
GRANT INSERT ON  [dbo].[TMWScrollCompute3PLBillingOrdersView] TO [public]
GO
GRANT SELECT ON  [dbo].[TMWScrollCompute3PLBillingOrdersView] TO [public]
GO
GRANT UPDATE ON  [dbo].[TMWScrollCompute3PLBillingOrdersView] TO [public]
GO
