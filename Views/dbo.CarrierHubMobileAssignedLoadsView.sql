...
CREATE view [dbo].[CarrierHubMobileAssignedLoadsView]
as
select 'TMWWF_CarrierHubMobile_ASSIGNED' AS 'TMWWF_CarrierHubMobile_ASSIGNED',
	leg.lgh_number,  
	leg.ord_hdrnumber,
...
GO
GRANT DELETE ON  [dbo].[CarrierHubMobileAssignedLoadsView] TO [public]
GO
GRANT INSERT ON  [dbo].[CarrierHubMobileAssignedLoadsView] TO [public]
GO
GRANT SELECT ON  [dbo].[CarrierHubMobileAssignedLoadsView] TO [public]
GO
GRANT UPDATE ON  [dbo].[CarrierHubMobileAssignedLoadsView] TO [public]
GO
