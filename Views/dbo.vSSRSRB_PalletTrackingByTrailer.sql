...
CREATE              View [dbo].[vSSRSRB_PalletTrackingByTrailer]
 ...
 *
 * NAME:
 * dbo.vSSRSRB_PalletTrackingByTrailer
 *
 * TYPE:
 * View
 *
...
Select
	...
	[Branch] = (Select trl_branch from trailerprofile WITH (NOLOCK) where pt_trailer_number = trailerprofile.trl_id)
      	
     
	

From    Pallet_Tracking
Where   pt_trailer_number <> 'UKNOWN' 
	and 
	pt_trailer_number <> 'UNK' 
	and 
	pt_trailer_number Is Not Null

	
GO
GRANT DELETE ON  [dbo].[vSSRSRB_PalletTrackingByTrailer] TO [public]
GO
GRANT INSERT ON  [dbo].[vSSRSRB_PalletTrackingByTrailer] TO [public]
GO
GRANT REFERENCES ON  [dbo].[vSSRSRB_PalletTrackingByTrailer] TO [public]
GO
GRANT SELECT ON  [dbo].[vSSRSRB_PalletTrackingByTrailer] TO [public]
GO
GRANT UPDATE ON  [dbo].[vSSRSRB_PalletTrackingByTrailer] TO [public]
GO
