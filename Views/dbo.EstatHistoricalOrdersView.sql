...
SET ANSI_NULLS ON
GO
CREATE view [dbo].[EstatHistoricalOrdersView] as 
select
...
GO
GRANT INSERT ON  [dbo].[EstatHistoricalOrdersView] TO [public]
GO
GRANT SELECT ON  [dbo].[EstatHistoricalOrdersView] TO [public]
GO
GRANT UPDATE ON  [dbo].[EstatHistoricalOrdersView] TO [public]
GO
