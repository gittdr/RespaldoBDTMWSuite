...
CREATE              View [dbo].[vSSRSRB_PalletTrackingByCarrier]

As
/**
 *
 * NAME:
 * dbo.vSSRSRB_PalletTrackingByCarrier
 *
 * TYPE:
 * View
 *
...
Select
	...
	[Branch] = (Select car_branch from carrier WITH (NOLOCK) where pt_carrier_id = carrier.car_id)

From    Pallet_Tracking
Where   pt_carrier_id <> 'UKNOWN' 
	and 	pt_carrier_id <> 'UNK' 
	and 	pt_carrier_id Is Not Null

	


GO
GRANT DELETE ON  [dbo].[vSSRSRB_PalletTrackingByCarrier] TO [public]
GO
GRANT INSERT ON  [dbo].[vSSRSRB_PalletTrackingByCarrier] TO [public]
GO
GRANT REFERENCES ON  [dbo].[vSSRSRB_PalletTrackingByCarrier] TO [public]
GO
GRANT SELECT ON  [dbo].[vSSRSRB_PalletTrackingByCarrier] TO [public]
GO
GRANT UPDATE ON  [dbo].[vSSRSRB_PalletTrackingByCarrier] TO [public]
GO
