...
CREATE             View [dbo].[vSSRSRB_PalletTrackingByTractor] 

As
/**
 *
 * NAME:
 * dbo.vSSRSRB_PalletTrackingByTractor
 *
 * TYPE:
 * View
 *
...
Select
	...
	[Branch] = (Select trc_branch from tractorprofile WITH (NOLOCK) where pt_carrier_id = tractorprofile.trc_number) 
      	
     
From    Pallet_Tracking
Where   pt_tractor_number <> 'UKNOWN' 
	and 	pt_tractor_number <> 'UNK' 
	and 	pt_tractor_number Is Not Null



GO
GRANT DELETE ON  [dbo].[vSSRSRB_PalletTrackingByTractor] TO [public]
GO
GRANT INSERT ON  [dbo].[vSSRSRB_PalletTrackingByTractor] TO [public]
GO
GRANT REFERENCES ON  [dbo].[vSSRSRB_PalletTrackingByTractor] TO [public]
GO
GRANT SELECT ON  [dbo].[vSSRSRB_PalletTrackingByTractor] TO [public]
GO
GRANT UPDATE ON  [dbo].[vSSRSRB_PalletTrackingByTractor] TO [public]
GO
