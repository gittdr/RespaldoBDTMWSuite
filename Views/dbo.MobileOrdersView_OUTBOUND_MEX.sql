...
CREATE view [dbo].[MobileOrdersView_OUTBOUND_MEX]
AS

/*******************************************************************************************************************  
SELECT * FROM MobileOrdersView_MEX
*******************************************************************************************************************/
...
AND ord.ord_hdrnumber in (SELECT ord_hdrnumber FROM legheader WHERE lgh_outstatus in ('AVL','PLN','STD') AND lgh_startregion1 in ('MX','PB'))
AND ord.ord_revtype3 IN ('BAJ','FULO','NOR','INTER')-- AND ord.ord_revtype4 IN('INT','SEN')
