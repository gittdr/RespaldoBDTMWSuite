...
CREATE view [dbo].[TMWScrollTractorView_ubicacionbup] AS
SELECT 
...
(select replace(convert(varchar,convert(Money, mpp_mile_day7),1),'.00','')  from manpowerprofile where mpp_id = trc_driver) end
