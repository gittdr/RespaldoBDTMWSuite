...
CREATE view [dbo].[MobileHistoricalTripsView]
AS
...
SELECT 'TMWWF_MOBILE_HISTORICAL_TRIPS' AS 'TMWWF_MOBILE_HISTORICAL_TRIPS',
		...
		LTRIM(RTRIM(leg.lgh_startstate)) 'PickupState',
		...
		CASE 
			...
			ELSE 'On Time'
		END 'OnTimeStatus' --TODO: UPDATE WITH ON TIME STATUS CALC	  
...
FROM	legheader leg WITH(NOLOCK)
...
GO
GRANT SELECT ON  [dbo].[MobileHistoricalTripsView] TO [public]
GO
