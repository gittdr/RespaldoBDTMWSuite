...
SET ANSI_NULLS ON
GO
CREATE view [dbo].[EstatQuotesOrdersView]
as 	select
		'TMWWF_ESTAT_QUOTES' as 'TMWWF_ESTAT_QUOTES',
		ord.ord_number,
...
GO
GRANT INSERT ON  [dbo].[EstatQuotesOrdersView] TO [public]
GO
GRANT SELECT ON  [dbo].[EstatQuotesOrdersView] TO [public]
GO
GRANT UPDATE ON  [dbo].[EstatQuotesOrdersView] TO [public]
GO
