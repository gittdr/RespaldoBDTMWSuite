...
CREATE VIEW [dbo].[OperationsDriverView_TDR] AS  
 SELECT  manpowerprofile.mpp_id                  mpp_id,  
   ...
   isnull(mpp_mile_day7,0) [7 Day Mileage],  
  ...
  (select count(*) from legheader (nolock) where lgh_driver1 = mpp_id and lgh_outstatus= 'PLN') as SegPLN
