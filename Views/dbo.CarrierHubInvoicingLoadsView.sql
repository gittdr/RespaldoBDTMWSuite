...
SET ANSI_NULLS ON
GO
create view [dbo].[CarrierHubInvoicingLoadsView]
as
	select 'TMWWF_CarrierHub_INVOICING' AS 'TMWWF_CarrierHub_INVOICING',
		...
		ordhead.ord_invoicestatus 'InvoiceStatus',
...
GO
GRANT DELETE ON  [dbo].[CarrierHubInvoicingLoadsView] TO [public]
GO
GRANT INSERT ON  [dbo].[CarrierHubInvoicingLoadsView] TO [public]
GO
GRANT SELECT ON  [dbo].[CarrierHubInvoicingLoadsView] TO [public]
GO
GRANT UPDATE ON  [dbo].[CarrierHubInvoicingLoadsView] TO [public]
GO
