...
CREATE view [dbo].[MobileOrdersView_OUTBOUND_QRO]
AS

/*******************************************************************************************************************  
SELECT * FROM MobileOrdersView_QRO
*******************************************************************************************************************/
...
AND ord.ord_hdrnumber in (SELECT ord_hdrnumber FROM legheader WHERE lgh_outstatus in ('AVL','PLN','STD') AND lgh_startregion1 = 'QR')
AND ord.ord_revtype3 IN ('BAJ','INTER')-- AND ord.ord_revtype4 IN('INT','SEN')
