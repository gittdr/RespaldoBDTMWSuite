...
CREATE VIEW [dbo].[TMWScrollInvoiceAllocAndReconcileOrders]
AS
...
SELECT DISTINCT orderheader.ord_number, 
  ...
  TMWAllocReconcileLinehaulBillView.RateMode AS 'RateMode'
FROM orderheader (NOLOCK)
  INNER JOIN TMWAllocReconcileLinehaulBillView ON TMWAllocReconcileLinehaulBillView.ord_hdrnumber = orderheader.ord_hdrnumber
...
GO
GRANT DELETE ON  [dbo].[TMWScrollInvoiceAllocAndReconcileOrders] TO [public]
GO
GRANT INSERT ON  [dbo].[TMWScrollInvoiceAllocAndReconcileOrders] TO [public]
GO
GRANT SELECT ON  [dbo].[TMWScrollInvoiceAllocAndReconcileOrders] TO [public]
GO
GRANT UPDATE ON  [dbo].[TMWScrollInvoiceAllocAndReconcileOrders] TO [public]
GO
