...
--select top 100 * from vTTSTMW_Injury
CREATE             View  [dbo].[vTTSTMW_SafetyInjury]
...
From    vTTSTMW_SafetyReport (NOLOCK) Inner Join Injury (NOLOCK) On Injury.srp_ID = vTTSTMW_SafetyReport.[Rpt Report ID]
				      Left Join Accident (NOLOCK) on Accident.[srp_id] = vTTSTMW_SafetyReport.[Rpt Report ID]
...
GO
GRANT SELECT ON  [dbo].[vTTSTMW_SafetyInjury] TO [public]
GO
