...
CREATE VIEW [dbo].[TMWScrollInvoiceView] AS
/*******************************************************************************************************************  
  Object Description:
  This query retrieves invoiceheader records, and is commonly used by Scrolls that involve invoicing
...
FROM dbo.invoiceheader (NOLOCK) 
  LEFT JOIN dbo.city ShipperCity (NOLOCK) ON dbo.invoiceheader.ivh_origincity = ShipperCity.cty_code 
  LEFT JOIN dbo.city ConsigneeCity (NOLOCK) ON dbo.invoiceheader.ivh_destcity = ConsigneeCity.cty_code 
  LEFT JOIN dbo.orderheader (NOLOCK) ON dbo.invoiceheader.ord_hdrnumber = dbo.orderheader.ord_hdrnumber
  LEFT JOIN dbo.stops (NOLOCK) ON dbo.stops.ord_hdrnumber = dbo.orderheader.ord_hdrnumber AND dbo.stops.ord_hdrnumber > 0 AND dbo.stops.stp_sequence = 1
GO
GRANT DELETE ON  [dbo].[TMWScrollInvoiceView] TO [public]
GO
GRANT INSERT ON  [dbo].[TMWScrollInvoiceView] TO [public]
GO
GRANT SELECT ON  [dbo].[TMWScrollInvoiceView] TO [public]
GO
GRANT UPDATE ON  [dbo].[TMWScrollInvoiceView] TO [public]
GO
