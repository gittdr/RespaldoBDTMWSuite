...
SET ANSI_NULLS ON
GO
CREATE VIEW [dbo].[Vista_liquidaciones_debe]
AS
...
WHERE        (dbo.payheader.pyh_payperiod > '2016-01-01') AND (dbo.payheader.pyh_paystatus IN ('XFR', 'REL')) AND
                             ((SELECT        ISNULL(SUM(ISNULL(pyd_amount, 0)), 0) * - 1 AS Expr1
...
Begin DesignProperties = 
   ...
   End
End
', 'SCHEMA', N'dbo', 'VIEW', N'Vista_liquidaciones_debe', NULL, NULL
GO
DECLARE @xp int
SELECT @xp=1
EXEC sp_addextendedproperty N'MS_DiagramPaneCount', @xp, 'SCHEMA', N'dbo', 'VIEW', N'Vista_liquidaciones_debe', NULL, NULL
GO
