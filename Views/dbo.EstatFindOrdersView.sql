...
SET ANSI_NULLS ON
GO
create view [dbo].[EstatFindOrdersView]
as select 
	ord.ord_number,
...
GO
GRANT INSERT ON  [dbo].[EstatFindOrdersView] TO [public]
GO
GRANT SELECT ON  [dbo].[EstatFindOrdersView] TO [public]
GO
GRANT UPDATE ON  [dbo].[EstatFindOrdersView] TO [public]
GO
