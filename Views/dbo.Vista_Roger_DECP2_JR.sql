...
SET ANSI_NULLS ON
GO
CREATE VIEW [dbo].[Vista_Roger_DECP2_JR]
AS
...
FROM            dbo.tractorprofile LEFT OUTER JOIN
                         dbo.tractoraccesories ON dbo.tractorprofile.trc_number = dbo.tractoraccesories.tca_tractor AND dbo.tractoraccesories.tca_type = 'DECP2' INNER JOIN
                         dbo.labelfile AS B ON dbo.tractorprofile.trc_type3 = B.abbr CROSS JOIN
                         dbo.labelfile AS A
WHERE        (dbo.tractorprofile.trc_status <> 'OUT') AND (dbo.tractorprofile.trc_number <> 'UNKNOWN') AND (A.abbr = 'DECP2') AND (A.labeldefinition = 'trcacc') AND (B.labeldefinition = 'TrcType3')
GO
...
Begin DesignProperties = 
   ...
   Begin CriteriaPane = 
      Begin ColumnWidths = 11
         ...
         Or = 1350
         Or = 1350
      End', 'SCHEMA', N'dbo', 'VIEW', N'Vista_Roger_DECP2_JR', NULL, NULL
GO
EXEC sp_addextendedproperty N'MS_DiagramPane2', N'
   End
End
', 'SCHEMA', N'dbo', 'VIEW', N'Vista_Roger_DECP2_JR', NULL, NULL
GO
DECLARE @xp int
SELECT @xp=2
EXEC sp_addextendedproperty N'MS_DiagramPaneCount', @xp, 'SCHEMA', N'dbo', 'VIEW', N'Vista_Roger_DECP2_JR', NULL, NULL
GO
