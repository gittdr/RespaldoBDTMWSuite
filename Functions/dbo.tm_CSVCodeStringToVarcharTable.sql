...
--select * from tm_CSVCodeStringToVarcharTable('''a'',b, c'', ''2'' ')
CREATE FUNCTION [dbo].[tm_CSVCodeStringToVarcharTable] (@List varchar(4000))
/*******************************************************************************************************************  
  Object Description:
...
END
GO
GRANT SELECT ON  [dbo].[tm_CSVCodeStringToVarcharTable] TO [public]
GO
