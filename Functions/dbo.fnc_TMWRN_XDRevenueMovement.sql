...
CREATE Function [dbo].[fnc_TMWRN_XDRevenueMovement]
(
	@MoveNumber int = Null,
							...
							from	(
										...
										From	(
													select distinct S0.ord_hdrnumber
														...
														,OrderRevenue = IsNull(dbo.fnc_TMWRN_XDRevenueOrder(@MinMilesToAllocate,default,S0.mov_number,S0.ord_hdrnumber,default,default,@BaseRevenueCategoryTLAFN,@IncludeChargeTypeList,@ExcludeChargeTypeList,@SubtractFuelSurchargeYN,@OnlyInvoicedRevenueYN,@InvoiceStatusList,@OrderStatusList),0.00)
...
GO
GRANT EXECUTE ON  [dbo].[fnc_TMWRN_XDRevenueMovement] TO [public]
GO
