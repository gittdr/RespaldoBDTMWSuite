...
SET ANSI_NULLS ON
GO
--select * from tmail_CSVCodeStringToVarcharTable('''a'',b, c'',''2'' ')
CREATE FUNCTION [dbo].[tmail_CSVCodeStringToVarcharTable] (@List varchar(4000))
/*******************************************************************************************************************  
  Object Description:
...
(
 ...
 Begin 
  ...
  INSERT INTO @Table
  SELECT [Value] = LTRIM(RTRIM(SUBSTRING(@List, l.N1, l.L1)))
  FROM cteLen l;
...
END
GO
GRANT SELECT ON  [dbo].[tmail_CSVCodeStringToVarcharTable] TO [public]
GO
