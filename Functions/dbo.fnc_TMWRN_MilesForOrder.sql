...
--select dbo.fnc_TMWRN_MilesForOrder(858,'','')


CREATE                   FUNCTION [dbo].[fnc_TMWRN_MilesForOrder] (@OrderHeaderNumber int,@LoadStatus varchar(50)='ALL',@EmptyMileAllocationMethod varchar(50)='DivideEvenly')--Eventually will be two other based on loaded allocation and other TBD
