...
CREATE FUNCTION [dbo].[Expstatus_GetCompletedExpiration_fn]
(
  @asgnType     VARCHAR(6),
  @asgnId       VARCHAR(13),
...
RETURNS @ExpstatusGetCompletedExpiration TABLE 
...
AS
BEGIN
  INSERT @ExpstatusGetCompletedExpiration
    SELECT TOP 1
            l.code,
            e.exp_compldate,
...
END  
GO
GRANT SELECT ON  [dbo].[Expstatus_GetCompletedExpiration_fn] TO [public]
GO
