...
CREATE Function [dbo].[fnc_TMWRN_RevenueSegment]
(
...
Begin 
	...
	Where	orderheader.mov_number = @MoveNumber
		And NOT EXISTS (select ord_hdrnumber from InvoiceHeader (NOLOCK) WHERE ord_hdrnumber = orderheader.ord_hdrnumber)
...
GO
GRANT EXECUTE ON  [dbo].[fnc_TMWRN_RevenueSegment] TO [public]
GO
