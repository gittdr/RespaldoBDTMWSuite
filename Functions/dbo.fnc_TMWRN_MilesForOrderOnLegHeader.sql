...
--select dbo.fnc_TMWRN_MilesForOrderOnLegHeader(1021,1044,1023,'ALL','') as TotalMiles,



CREATE                       FUNCTION [dbo].[fnc_TMWRN_MilesForOrderOnLegHeader] (@OrderHeaderNumber int,@LegHeaderNumber int,@MoveNumber int,@LoadStatus varchar(50)='ALL',@EmptyMileAllocationMethod varchar(50)='DivideEvenly')--Eventually will be two other based on loaded allocation and other TBD
