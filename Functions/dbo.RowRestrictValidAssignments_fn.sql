...
CREATE  FUNCTION [dbo].[RowRestrictValidAssignments_fn](@TableName varchar(50))
RETURNS @Table TABLE	(
...
END
GO
GRANT REFERENCES ON  [dbo].[RowRestrictValidAssignments_fn] TO [public]
GO
GRANT SELECT ON  [dbo].[RowRestrictValidAssignments_fn] TO [public]
GO
