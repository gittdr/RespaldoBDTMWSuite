...
CREATE                    Function [dbo].[TMWSSRS_fnc_checkforvalidcurrencyconversion](@charge money,@currency varchar(25),@typeofcharge varchar(255),@referencnumber int,@currencydate datetime='',@shipdate datetime='',@deliverydate datetime='',@billdate datetime='',@revenuedate datetime='',@transferdate datetime='',@bookdate datetime='',@printdate datetime='',@transactiondate datetime='',@workperioddate datetime='',@payperioddate datetime='')   
RETURNS varchar (40)  
