...
create function [dbo].[TMWSSRS_fcn_CommoditiesWeight_CRLF]
(	
...
GO
GRANT EXECUTE ON  [dbo].[TMWSSRS_fcn_CommoditiesWeight_CRLF] TO [public]
GO
GRANT REFERENCES ON  [dbo].[TMWSSRS_fcn_CommoditiesWeight_CRLF] TO [public]
GO
