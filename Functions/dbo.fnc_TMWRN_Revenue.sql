...
CREATE Function [dbo].[fnc_TMWRN_Revenue] 
(
...
Begin 
	...
	IF @Mode = 'Invoice' 
	BEGIN 
		Set @Revenue = dbo.fnc_TMWRN_RevenueInvoice(@MilesToAllocate,@MoveMiles,@MoveNumber,@OrderHeaderNumber,@LegHeaderNumber,@InvoiceHeaderNumber,@IncludeChargeTypeList,@ExcludeChargeTypeList,@LineHaulRevenueOnlyYN,@AccRevenueOnlyYN,@OnlyRevenueFromChargeTypesYN,@ExcludeBillToIDList,@IncludeBillToIDList,@OrderStatusList,@InvoiceStatusList)
	END
	ELSE IF @Mode = 'Order'
	BEGIN
		Set @Revenue = dbo.fnc_TMWRN_RevenueOrder(@MilesToAllocate,@MoveMiles,@MoveNumber,@OrderHeaderNumber,@LegHeaderNumber,@InvoiceHeaderNumber,@IncludeChargeTypeList,@ExcludeChargeTypeList,@LineHaulRevenueOnlyYN,@AccRevenueOnlyYN,@OnlyRevenueFromChargeTypesYN,@ExcludeBillToIDList,@IncludeBillToIDList,@OrderStatusList,@InvoiceStatusList)
	END
	ELSE IF @Mode = 'Movement'
	BEGIN
		Set @Revenue = dbo.fnc_TMWRN_RevenueMovement(@MilesToAllocate,@MoveMiles,@MoveNumber,@OrderHeaderNumber,@LegHeaderNumber,@InvoiceHeaderNumber,@IncludeChargeTypeList,@ExcludeChargeTypeList,@LineHaulRevenueOnlyYN,@AccRevenueOnlyYN,@OnlyRevenueFromChargeTypesYN,@ExcludeBillToIDList,@IncludeBillToIDList,@OrderStatusList,@InvoiceStatusList)	
	END
	ELSE IF @Mode = 'Segment'
	BEGIN
		Set @Revenue = dbo.fnc_TMWRN_RevenueSegment(@MilesToAllocate,@MoveMiles,@MoveNumber,@OrderHeaderNumber,@LegHeaderNumber,@InvoiceHeaderNumber,@IncludeChargeTypeList,@ExcludeChargeTypeList,@LineHaulRevenueOnlyYN,@AccRevenueOnlyYN,@OnlyRevenueFromChargeTypesYN,@ExcludeBillToIDList,@IncludeBillToIDList,@OrderStatusList,@InvoiceStatusList)		
	END
	ELSE IF @Mode = 'LegHeader'
	BEGIN
		Set @Revenue = dbo.fnc_TMWRN_RevenueLegheader(@MilesToAllocate,@MoveMiles,@MoveNumber,@OrderHeaderNumber,@LegHeaderNumber,@InvoiceHeaderNumber,@IncludeChargeTypeList,@ExcludeChargeTypeList,@LineHaulRevenueOnlyYN,@AccRevenueOnlyYN,@OnlyRevenueFromChargeTypesYN,@ExcludeBillToIDList,@IncludeBillToIDList,@OrderStatusList,@InvoiceStatusList)	
	END
	ELSE IF @Mode = 'MilesSum'
	BEGIN
		Set @Revenue = dbo.fnc_TMWRN_RevenueMilesSum(@MilesToAllocate,@MoveMiles,@MoveNumber,@OrderHeaderNumber,@LegHeaderNumber,@InvoiceHeaderNumber,@IncludeChargeTypeList,@ExcludeChargeTypeList,@LineHaulRevenueOnlyYN,@AccRevenueOnlyYN,@OnlyRevenueFromChargeTypesYN,@ExcludeBillToIDList,@IncludeBillToIDList,@OrderStatusList,@InvoiceStatusList)		
	END
...
GO
GRANT EXECUTE ON  [dbo].[fnc_TMWRN_Revenue] TO [public]
GO
