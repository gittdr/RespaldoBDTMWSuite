...
SET ANSI_NULLS OFF
GO
create function [dbo].[ToZulu]( @LocalDate datetime, @BaseDateTZ int, @DSTCode int, @BaseDateTZAddlMins int)
returns datetime 
BEGIN
    ...
    declare @WorkDate datetime, @DSTCheckLocal char(1)
...
END
GO
GRANT EXECUTE ON  [dbo].[ToZulu] TO [public]
GO
GRANT REFERENCES ON  [dbo].[ToZulu] TO [public]
GO
